...
\def\@makechapterhead#1{%
  \vspace*{10\p@}%
{\fontsize{13pt}{13pt}\selectfont\raggedright{\bf  ke. si. pAMDe}\par}
\vspace*{25\p@}%
...
\noindent
\eng{\textsc{Bosanquet} : \em   History of Aesthetics}

\noindent
\eng{\textsc{Addison, Joseph} : {\em Works,} Vol. III.}

\noindent
\eng{\textsc{Kant} : {\em Critique of Judgment } (Eng. trans. by J. H. Bernard).}

\noindent
\eng{\textsc{Inge}, W. R.: {\em The Philosophy of Plotinus}, Vol, II.}
