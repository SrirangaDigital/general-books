...
\eng{I MAHATMAGANDHI-100 Years} kaqtiyiMda:
\begin{itemize}
\itemsep=4pt
\item[\eng{1.}] bArfbArAvaDaR jAkfsanf avara `mAnavanalilxruva oLeLxyatanada vakiVla' eMba leVKana.

\item[\eng{2.}] kArflx jAsapxrf avara `nUraneya janamxdinadalilx gAMdhi' eMba leVKana.

\item[\eng{3.}] i. sATxyXnilx joVnfsx avara `ahiMsAtamxka asahakArakekx nananx parivaratxne' eMba leVKana.

\item[\eng{4.}] suceVta kaqpalAni avara `sitxrXVyara magaRdashaRka matutx guru' eMba leVKana.
\end{itemize}

\eng{II. History of philosophy: Eastern and western:-Vol-I} kaqtiyiMda:
\begin{itemize}
\itemsep=4pt
\item[\eng{1.}] sushiVlf kumArf DeV avara `mahAkAvayxgaLu: (A) mahABArata'  eMba leVKana.

\item[\eng{2.}] e. ke. bAyxnajiR avara `viSuNx matutx BAgavata purANagaLu' eMba leVKana.

\item[\eng{3.}] esf. ke. pAMDe avara `BAratiVya swMdayaR jijAcnxse' eMba leVKana.

\item[\eng{4.}] BeYjoVdf siMgf avara `siKfdashaRna' eMba leVKana.
\end{itemize}

\newpage

\eng{III. Cultural Heritage of India-Vol-1} kaqtiyiMda:
\begin{itemize}
\itemsep=0pt
...
\eng{IV. Cultural Heritage of India-Vol-II} kaqtiyiMda:
\begin{itemize}
\item[\eng{1.}] sAvxmi tapasAyxnaMdara `BagavadigxVteya dhamaR' eMba leVKana.
\end{itemize}

\eng{V. cultural Heritage of India-Vol-III} kaqtiyiMda:
\begin{itemize}
\itemsep=0pt
...
\eng{VI. Cultural Heritage of India-Vol-IV} kaqtiyiMda:
\begin{itemize}
\item[\eng{1.}] benAyf toVSf BaTATxcAyaR avara `bwdadhxra tAMtirxka saMsakxqqti' eMba leVKana.
\end{itemize}

\eng{VII.} vishavxdhamaRdashaRna-saM-2 kaqtiyiMda
\begin{itemize}
...
nananx duDimeya hiMdina cAlakashakitxyAda nananx shirxVmati DA. si. esf. pavitArx\-LigU, makakxLAda ciraMjiVvi sudhanavx hAgU caMpALigU, atetx shirxVmati canAnxjamAmx avarigU BAvameYdunarAda ke.~esf.~manoVhara, bi.~ke.~puniVta, ke.~ esf.~\hbox{naTeVshf} avarugaLigU hAgU nananx necicxna nAdiniyarAda kumAri pirxyAMka, suniVta, beVbikalA hAgU BAgayx avarugaLigU nananx kaqtajacnxtegaLu.
