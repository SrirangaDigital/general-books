...
Pollock labeled the first type --- the Casaubon type\index{Plane 1 philology} --- of philology\index{philology!historicist} as “historicist” or “Plane 1” philology, and the\index{historicist philology} latter --- the Nietzsche\index{Nietzsche, Friedrich} type --- as “presentist” or “Plane 3” philology.\index{philology!presentist}\index{philology!Plane 3} To this list, he added a Plane- 2 philology\index{plane 2 philology}\index{philology!traditionist}\index{philology!Plane 2} --- the “traditionist philology”. 
...
It is interesting how Pollock takes a gigantic leap from the divinity\index{divinity!of Rāma} of Rāma to the divinity\index{divinity!of a king} of a king in general.\index{misinterpretation!techniques of!overgeneralization}
...
\begin{itemize}
\itemsep=-1pt
\item[(a)] Rāma’s divinity\index{divinity!of Rāma} is identical to divinity\index{divinity!of a king} of Indian kings 
...
Yet, an important difference exists between the two sets of stories --- in the first set, Lord Viṣṇu\index{Visnu@Viṣṇu} is directly appealed to, and it is he who takes the matter into hand; in the second set, a ruse is created by the different gods to bring the downfall of the villain (in the first story, a celestial woman is created, in the other, a celestial boy). Lord Viṣṇu’s {\sl avatāra}\index{avatara@\textsl{avatāra(s)}}\index{avatara@\textsl{avatāra(s)}!of Viṣṇu} is not equivalent to the “{\sl ruse}” that is “emanating from the gods and yet not one of them” (Pollock 2007b:36). In the {\sl Rāmāyaṇa}, the Bāla-kāṇḍa\index{Balakanda@Bāla-kāṇḍa} narrates the story of the gods’ appeal to Lord Viṣṇu and his promise to come down as a human to vanquish Rāvaṇa.\index{Ravana@Rāvaṇa} 
...
\smallskip
\textbf{Lord Viṣṇu\index{Visnu@Viṣṇu} (to Gods):} ({\sl Rāmāyaṇa} 1.15.27-28)\\[-20pt]
...
{\sl Avatāra}-s, in Indian tradition, are of different types: {\sl āveśa}\index{avatara@\textsl{avatāra(s)}!types of!avesa@\textsl{āveśa}} (inspired) (Narasiṁha,\index{Narasimha@Narasiṁha} for example); {\sl aṁśa}\index{avatara@\textsl{avatāra(s)}!types of!amsa@\textsl{aṁśa}} (partial) and {\sl pūrṇa}\index{avatara@\textsl{avatāra(s)}!types of!purna@\textsl{pūrṇa}} (complete)\endnote{The {\sl Pāñcarātra} classifies {\sl avatāra}-s as follows: (1) {\sl sākṣād} (Direct) (2) {\sl āveśa} (Entrance or Possessed) (3) {\sl vyūha} (Grouped or Arranged) (4) {\sl antaryāmin} (Inner Controller) (5) {\sl arcā} (Worship).}. They are all “Descents” in play --- {\sl līlāvatāra}.\index{avatara@\textsl{avatāra(s)}!types of!lilavatara@\textsl{līlāvatāra}} The Purāṇa-s enumerate 14 {\sl manvantarāvatāra}-s,\index{avatara@\textsl{avatāra(s)}!types of!manvantaravatara@\textsl{manvantarāvatāra}} 25 {\sl kalpāvatāra}-s,\index{avatara@\textsl{avatāra(s)}!types of!kalpavatara@\textsl{kalpāvatāra}} 4 {\sl yugāvatāra}-s\index{avatara@\textsl{avatāra(s)}!types of!yugavatara@\textsl{yugāvatāra}} --- of them, ten have attained greater popularity. A popular verse enumerates ten of them in a chronological order:\index{avatara@\textsl{avatāra(s)}!of Visnu@of Viṣṇu}
\begin{quote}
...
We see a clear distinction between a {\sl divine} king,\index{divine king} and a {\sl human} king\index{human king} in the context when Soma, the divine king, comes as a guest, it is said that he must be given what is due to him as a guest; in the same breath, it is said that when a {\sl human} king is received as a guest, an ox must be killed for him.  So we see that “human kings” are seen as antithetic to gods, and as mortal compared with immortals\endnote{{\sl Aitareya-brāhmaṇa} 1.15; 8.23f. For the ritual, see {\sl Aitareya-brāhmaṇa} 7.22f; 8.11f; {\sl Śatapatha-brāhmaṇa} 3.2.1.40; 5.3.3.9 and 12; 5.4.4.5; {\sl Taittirīya-saṁhitā} 3.5.3.2. etc and for a thorough discussion of origin of kingship, see U N Ghoshal (1923).}. So it is that the divinity of Pṛthu Vainya\index{Prthu Vainya@Pṛthu Vainya} is not established in spite of the feats he performs because of his virtuosity (when he wanted to walk over the seas, water solidified and let him walk on water: {\sl āpas tastambhire cāsya samudram abhiyāsyataḥ - Mahābhārata}\index{Mahabharata@\textsl{Mahābhārata}} 12.59.123). On the other hand, it is said, “Viṣṇu\index{Visnu@Viṣṇu} entered his (Pṛthu’s)\index{Prthu Vainya@Pṛthu Vainya} body, and so the world bows to this king as to a god among human gods” ({\sl Mahābhārata} 12.59.130)
\begin{quote}
