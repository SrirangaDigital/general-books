...
Grammatically, the word {\sl kṣatra} is derived from the root {\sl kṣaṇu hiṁsāyām}, and etymologically, it is {\sl kṣatāt nāśāt trāyata iti kṣatraṁ}. The word itself refers, therefore, to “protection”.  We know that instances of {\sl kṣatriya’s} duty (of protection) abound in Indian literature. When, for example, in Kālidāsa’s {\sl Raghu-vaṁśa},\index{Raghuvamsa@\textit{Raghu-vaṁśa}} Nandinī, sage Vaśiṣṭha’s cow, faces threat from Kumbhodara, the lion, Dilīpa offers to sacrifice his own self in order to protect Nandinī. And Dilīpa says (Dilīpa to Kumbhodara):
\begin{quote}
...
\textbf{Gods addressing Viṣṇu:} ({\sl Rāmāyaṇa} 1.15.23-24). 
\begin{quote}
...
{\sl Avatāra}-s, in Indian tradition, are of different types: {\sl āveśa} (inspired) (Narasiṁha, for example); {\sl aṁśa} (partial) and {\sl pūrṇa} (complete)\endnote{The {\sl Pāñcarātra} classifies {\sl avatāra}-s as follows: (1) {\sl sākṣād} (Direct) (2) {\sl āveśa} (Entrance or Possessed) (3) {\sl vyūha} (Grouped or Arranged) (4) {\sl antaryāmin} (Inner Controller) (5) {\sl arcā} (Worship).}. They are all “Descents” in play --- {\sl līlāvatāra}. The {\sl purāṇa}-s enumerate 14 {\sl manvantarāvatāra}-s, 25 {\sl kalpāvatāra}-s, 4 {\sl yugāvatāra}-s --- of them, ten have attained greater popularity. In a verse, {\sl Mahābhārata}\index{Mahabharata@\textit{Mahābhārata}} enumerates ten of them in a chronological order: 
\begin{quote}
