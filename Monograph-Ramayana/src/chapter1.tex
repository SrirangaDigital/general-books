...
\subsubsection{Exercise : A   Brief History of Higher Criticism}\label{sec1.1.1.1}
...
\hfill [{\sl Transln:} Ingalls {\sl et al}] [{\sl italics ours}]
\end{myquote}
...
Talageri shows that while these kings are descendents of Bharata, they are also called Pūru-s:\index{Puru-s@Pūru-s} according to the {\sl purāṇā}-s, the Bharata-s\index{Bharata} are a branch of the Pūru-s; this is further confirmed in the {\sl Ṛgveda}\index{Rgveda@\textit{Ṛgveda}} where both Divodāsa ({\sl Ṛgveda} 1.130.7) and Sudās (1.63.7) are called Pūru-s, and Parucchepa Daivodāsī repeatedly speaks as a Pūru ({\sl Ṛgveda} 1.129.5; 131.4). The other prominent dynasty in the {\sl Ṛgveda} is the Tṛkṣi dynasty of Māndhātā, identifiable as a branch of the Ikṣvāku-s. An extensive analysis of the dynasties is made in Talageri (2000). From the {\sl purāṇa}-s, a more exhaustive list can be compiled--- although the value of historical material from the {\sl purāṇa}-s is sometimes contested in Western academia.
...
The “final, and critical, intrinsic problem of kingship”, says Pollock, is the divisive and usually violent dynastic struggle that accompanies the hereditary transference of power. In the earlier tradition, Pollock says, (referring to the {\sl Mahābhārata}\index{Mahabharata@\textit{Mahābhārata}} and the {\sl Harivaṁśa}),\index{Harivamsa@\textit{Harivaṁśa}} there was only one method to resolve this difficulty of transference of heredity-power\index{heredity-power} --- that of armed combat. He writes,
...
Pollock treats of the “great symphony” between the Ayodhyākāṇḍa and the Sabhā-parvan in a separate segment; his list of “similarities” is as follows: 
\begin{itemize}
...
First of all, the word {\sl prāpta-kāla} must be interpreted as destiny, not “best time”; so 2.4.25 reads, “I think it is destiny that your consecration should take place when Bharata is away.” It is {\sl in a tone of regret} that Daśaratha says these words, {\sl not craftily}. Secondly, Pollock translates the work {\sl kṛta-śobhi} (2.4.27) as “accomplished act”. In doing so, he blatantly ignores the epithet “{\sl śobhi}”. The word literally refers to the splendid nature/praiseworthiness of an act. The correct translation of the verse will then mean, “O Rāma! It is my opinion that minds of men are inconstant. But ({\sl kintu}) a virtuous person (like Bharata - {\sl dharma-nityānām satām ca}) will only praise a good that has been done ({\sl kṛta-śobhi}), [i.e. the consecration ceremony]”. 
...
\noindent
\textbf{(c) Kausalyā:}\index{Kausalya@Kausalyā}  When Bharata and Śatrughna return from visiting their maternal and hear of the misfortunes that elapsed in their presence, they rush to meet Kausalyā. Upon seeing them, Kausalyā vents out (Kausalyā to Bharata): 
\begin{quote}
{{\sl idaṁ te rājya-kāmasya rājyaṁ prāptam akaṇṭakam}} |\\
{\sl samprāptaṁ bata kaikeyyā śīghraṁ krūreṇa karmaṇā} || 

\hfill ({\sl Rāmāyaṇa} 2.69.6)
\end{quote}
...
It is then that Kaikeyī demands the fulfillment of her wishes. But {\sl nowhere} is a mention of {\sl rājya-śulka} made. It is hard to conceive any legitimate reason for the conspicuous absence of its mention.
...
\hfill({\sl Chāndogyopaniṣad}\index{Chandogyopanishad@\textit{Chāndogyopaniṣad}} III. 17.1-5 ) 
\end{myquote}
