...
\makebox[\textwidth]{\includegraphics[width=1.05\paperwidth]{src/Figures/erasure_coding.jpg}}
...
\end{multicols}
 ...
 \begin{multicols}{2}
	...
	\subsection{Explaining the Need for {\fontsize{11}{13}\selectfont Sub-packetization}}
	...
	\subsection{Formal Definition of a Regenerating\hfill\break Code} 
...
\subsection{Desired Properties of a Regenerating\hfill\break Code} 
...
\een
 ...
 \bean
 \{ (n=4,k=2,d=3), (\alpha=4,\beta=2), B=8, \fq=\mathbb{F}_4 \ \text{\footnotesize $(q=4)$}\}. 
 \eean
...
Foundation under Grant No. 1421848 as well as from the NetApp University Research Fund, a corporate advised fund of the Silicon Valley Community Foundation.\raisebox{-.1cm}{\includegraphics[scale=.9]{src/Figures/circledC.eps}}
...
\clineB{1-2}{2.5}
 &\\
\raisebox{-3cm}{\includegraphics{src/Figures/authors/Nikhil_photo.jpeg}} &
...
M. Nikhil Krishnan received his B. Tech. in Electronics and Communication Engineering from Amrita School of Engineering, Kollam, in 2011 and M. E. in Telecommunication from the Indian Institute of Science (IISc), Bangalore, in 2013. He is currently a Visvesvaraya Ph.D. scholar at the Department of Electrical Communication Engineering, IISc. His research interests include coding theory and information theory.\\
 &\\
\raisebox{-3.4cm}{\includegraphics{src/Figures/authors/Myna_Vajha.jpeg}} &
...
Myna Vajha received B. Tech in Electronics and Electrical Communications Engineering from IIT Kharagpur in 2011, and Masters from EE Department, University of Southern California (USC), in 2013. She is currently a Ph.D. student at the department of Electrical Communication Engineering in Indian Institute of Science, Bangalore. She has worked with Ericsson and Qualcomm in the past as a software architect, engineer respectively. Her research interests include coding theory and information theory, with applications to distributed storage systems.\\
 &\\
\raisebox{-3cm}{\includegraphics{src/Figures/authors/Vinayak_photo.jpeg}} & 
...
&\\  
\raisebox{-3cm}{\includegraphics{src/Figures/authors/Balaji_Photo.jpeg}} & 
