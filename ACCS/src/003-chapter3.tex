...
\bigskip
\noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{src/Figures/chap3/stock-vector-presentation-layer-osi-model-vector-illustration-333711977.jpg}}
