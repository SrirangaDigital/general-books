...
This is a foundational claim\endnote{Though based on Appayya Dīkṣita's\index{Appayya Diksita@\textit{Appayya Dīkṣita}} work, there is no “global” perspective provided on the “actual” prevailing traditions of interpretation. Is such over-generalization warranted?} aimed to deconstruct (break and falsify) the primary edifice of the \textit{sanātanic} system. Based on the reactions (from practicing Sanatanists) to these interpretations, these theses do not read like those of a decorated academic scholar but are indicative of a deeply disturbed mind. \textit{Dharma\index{dharma@\textit{dharma}}, Brahman\index{brahman@\textit{brahman}}} and \textit{Puruṣārtha}\index{purusartha@\textit{puruṣārtha}} - the basic constructs of the civilizational epistemology - are claimed to be \textbf{fabrications} of Mīmāṁsā\index{mimamsa@Mīmāṁsā}.
