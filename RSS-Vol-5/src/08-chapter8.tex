...
\subsubsection{Veda\index{vedas@\textit{Veda}-s} and \textit{Kāvya}\index{kavya@\textit{kāvya}} – Does Difference mean Discontinuity?}
...
\subsubsection{‘Kavi’:\index{kavi@\textit{kavi}} Erased from the memory of Premodern South Asians}
...
\subsection{\textit{Kāvya}\index{kavya@\textit{kāvya}} in Veda\index{vedas@\textit{Veda-s}} and \textit{Nāṭya\index{Natyasastra@\textit{Nāṭyaśāstra}} Śāstra}: More evidence}
...
\subsection{The Nexus between \textit{Kāvya}\index{kavya@\textit{kāvya}} and \textit{Rājya}\index{rajya@\textit{rājya}}}
