...
\rhead[]{\thechapter. {\englishfont History in India: A Critique from the Perspective of Mīmāṁsā}\quad\small\thepage}
\input src/01-chapter1.tex %chap1
\clearpage
\selectlanguage{english}
\lhead[\thepage\quad \englishfont T. N. Sudarshan]{}
\rhead[]{\thechapter. {The Science and Nescience of Mīmāṁsā}\quad \thepage}
...
\rhead[]{\thechapter. \devanagarifont\large मीमांसा, भारतीयानाम् अनैतिहासिकत्वञ्च\quad\thepage}
...
\selectlanguage{english}
\lhead[\thepage\quad \englishfont T. N. Sudarshan]{}
\rhead[]{\thechapter. {The Science of the Sacred}\quad\thepage}
...
\rhead[]{\thechapter. {On Desacralization of Sanskrit}\quad\thepage}
\input src/06-chapter6.tex %chap6
\newpage
\selectlanguage{english}
\lhead[\thepage\quad \englishfont T. N. Sudarshan]{}
\rhead[]{\thechapter. {The Science of Meaning}\quad\thepage}
...
\rhead[]{\thechapter. {Saṁskṛti in Context}\quad\thepage}
\input src/08-chapter8.tex %chap8
\clearpage
\lhead[\thepage\quad \englishfont T. N. Sudarshan and T. N. Madhusudan]{}
\rhead[]{\thechapter. {The Śāstra of Science and the Science of Śāstra}\quad\thepage}
...
\rhead[]{Contributors\quad\thepage}
