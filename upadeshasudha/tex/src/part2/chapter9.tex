...
\begin{shloka}
`parxyoVjanamanudidxshayx na maMdoV\char'263 pi parxvataRteV |'
\end{shloka}
...
\begin{shloka}
``bArxhamxNasayx hi deVhoV\char'263 yaM noVpaBoVgAya kalapxteV |\\
...
\begin{shloka}
`kAyaRmiteyxVva yatakxmaR niyataM kirxyuteV\char'263 juRna |'
\end{shloka}
