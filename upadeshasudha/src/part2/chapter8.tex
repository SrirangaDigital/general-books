...
na tavxtasxmoV\s satxyXpayxdhikaH kutoV\s noyxV loVkAtarxyeV\s payx parxtimaparxBAva ||
\end{shloka}
...
\begin{shloka}
`tateYha ramaNiVya caraNAH$\ldots$ ramaNiVyAM yoVniM\\
apadeyxVranf$\ldots$ kapUya caraNA kapUyaM yoVnimA\\
padeyxVranf'
\end{shloka}
...
\begin{shloka}
`tathA shariVrANi vihAya jiVNARnayxnAyxni saMyAMti navAni deVhiV ||'
\end{shloka}
