\chapter[{\sl Rasa:} From \textsl{Nāṭyaśāstra} to Bollywood]{{\sl\bfseries Rasa:} From \textsl{Nāṭyaśāstra} to Bollywood}\label{chapter\thechapter:begin}
...
\textsl{Rasa}, meaning gist, is the essence that one feels while experiencing an art piece, be it performative or static art. In the Indian context, and as applied to both the performer and the audience, \textsl{Rasa} is considered an \textsl{alaukika}\index{alaukika@\textsl{alaukika}} (other worldly) experience. An integral part of aesthetics, both Indian and Greek (although European performing arts moved away from the original concept of Greek aesthetics), is improvisation on the rules that are suggested for a clear structure, which by definition is fluid and allows room for newness. Using Bharat Gupt’s\index{Gupt, Bharat} study of poetics and \textsl{Nāṭyaśāstra},\index{Natyasastra@\textsl{Nāṭyaśāstra}} this paper will focus on the similarities in Indian and Greek aesthetics,\index{Greek!aesthetics} also highlighting when and why the contemporary notion of aesthetics in European theatre moved away from the Greek, which was more similar to the Indian sensibility. There will also be a focus on the concept of \textsl{hieropraxis} (art as worship, pleasing both people and Gods), which was common, to Indian and Greek art forms. Finally, the paper will illustrate, through examples of Bollywood\index{Bollywood} and interviews with \textsl{Bharatanāṭya}\index{Bharatanatya@\textsl{Bharatanāṭya}} teachers (in Sweden), how improvisation, and newness is brought into various aspects of performance arts, thereby challenging Prof. Sheldon Pollock’s\index{Pollock, Sheldon} reading of the \textsl{Nāṭyaśāstra}\index{Natyasastra@\textsl{Nāṭyaśāstra}} as being rigid and frozen in time, and as devoid of bringing novelty, thereby making the work irrelevant to our times. 
...
Although the story of Indra and the ants, (from the \textsl{Brahmavaivarta Purāṇa}) --- \index{Purana@Purāṇa!\textsl{Brahmavaivarta}}\index{Brahmavaivartapurana@\textsl{Brahmavaivarta Purāṇa}} where Lord Viṣṇu, in the form a young boy with blue skin, visits Indra and convinces him to question his ego driven involvement in the world -- is quite well known, the story that follows is usually forgotten. Humbled by Viṣṇu's visit, Indira decides to renounce the world and become a yogi and meditate on the lotus feet of Viṣṇu. Indrāṇī, the beautiful wife of Indra, is upset by the news that Indra wishes to renounce the world, and goes to a priest for counsel. Understanding the dilemma of the queen, the priest says that he has a solution which would be pleasing both to Indra and Indrāṇī. As both approach Indra sitting on his throne, a symbol of power and authority, the priest says, 
...
All arts are supposed to give us a reflection of the \textsl{pāramārthika}\index{paramarthika@\textsl{pāramārthika}} in the \textsl{vyāvahārika}.\index{vyavaharika@\textsl{vyāvahārika}} In Indic tradition, the ultimate purpose of art, other than merely entertaining its audiences, has always been to bridge the gap between the worldly (\textsl{vyāvahārika}) and the transcendent (\textsl{pāra\-mā-\break\-rthika})---by bringing together aspects of \textsl{laukika}\index{laukika@\textsl{laukika}} (the worldly) in the arts such as it points towards ways of experiencing the \textsl{alaukika.}\index{alaukika@\textsl{alaukika}}\\[-21pt]

\section*{Purpose of Art in Indic Tradition:}

Called the fifth Veda (like the Purāṇa-\textsl{s} and the Itihāsa), the \textsl{Nāṭyaśāstra}\index{Natyasastra@\textsl{Nāṭyaśāstra}}\endnote{\textsl{Nāṭyaśāstra---} where words were extracted out of \textsl{Ṛgveda},\index{Rgveda@\textsl{Ṛgveda}}\index{Veda-s@\textsl{Veda}-s!Rgveda@\textsl{Ṛgveda}} music from \textsl{Sāmaveda},\index{Samaveda@\textsl{Sāmaveda}}\index{Veda-s@\textsl{Veda}-s!Samaveda@\textsl{Sāmaveda}} \textsl{abhinaya} out of \textsl{Yajurveda}\index{Yajurveda@\textsl{Yajurveda}}\index{Veda-s@\textsl{Veda}-s!Yajusveda@\textsl{Yajusveda}} and \textsl{rasa} out of \textsl{Atharvaveda}\index{Atharvaveda@\textsl{Atharvaveda}}\index{Veda-s@\textsl{Veda}-s!Atharvaveda@\textsl{Atharvaveda}} and combined them with muthoi or Itihāsa to complete the fifth Veda called Nāṭya Veda (\textsl{Nāṭyaśāstra}:\index{Natyasastra@\textsl{Nāṭyaśāstra}} 1:11-19 as cited in Gupt\index{Gupt, Bharat} 2006:70).}---was composed to make the knowledge of the \hbox{Veda-s}\index{Veda-s@\textsl{Veda}-s} accessible to all factions of society, by evoking an experience in the audience that was commensurate with their own abilities of understanding art, and was beyond academic and formal knowledge. Though remembered more as a poet than a philosopher, Nobel Laureate Tagore,\index{Tagore, Rabindranath} in his essays defied all definitions of art by combining and comparing poetry with philosophy. Tagore believed that art relieved the audience from the clutches of reality, and moved the viewer/spectator into the other-worldly, not unlike what is proposed in the \textsl{Nāṭyaśāstra}. \index{Natyasastra@\textsl{Nāṭyaśāstra}}
...
The following section discusses the development of Indian drama, and the centrality of the sacred to Indian drama, the characteristics that make an ideal audience as listed by Bharata Muni,\index{Bharatamuni} how Indian and Greek\index{Greek!drama} drama developed independent of each other, and why unlike the \textsl{Poetics}, the principles of \textsl{Nāṭyaśāstra}\index{Natyasastra@\textsl{Nāṭyaśāstra}} actually can be applied both to drama and poetry. 

\vskip .15cm

\textbf{Indian drama:} The history of theatrical shows on festive situations is not so well documented in India, as it is in Greece. Since there is no mention, even in the \textsl{Nāṭyaśāstra}, about any precedent from where theatre could have been developed, scholars have often made several guesses on the development of the \textsl{daśa-rūpaka}-s\index{dasarupakas@\textsl{daśa-rūpaka}-s} (ten genres of acting) (Gupt 2006).  It is believed that the first Indian drama was puppetry and probably that is why the narrator is called a ‘\textsl{Sūtra-dhāra’}. However, Gupt (2006) argues that the proponents of the theory did not consider the possibility that this thread-bearer (\textsl{Sūtra-dhāra)} was so called because, like all architects, he carried a thread to measure the land for the theatre building---which was constructed anew each time a performance session was held (Gupt 2006:70). 

\vskip .15cm

\begin{myquote}
Like all architects he carried a thread to measure the land for the theater building which was constructed anew each time a performance session was held. Besides the master director is called the \textsl{acarya} in the NS [\textsl{Nāṭyaśāstra}], and he was most likely not the same as \textsl{Sutradhara}. 
...
\textbf{\textsl{Rasa} and \textsl{Rasa} Theory:} What is ‘\textsl{Rasa}'?\index{rasa@\textsl{rasa}}
 ‘\textsl{Rasa}\endnote{In Ayurvedic terminology, the word \textsl{rasa} was used to denote the vital juice that the digestive system extracts from food and which is later converted into blood, flesh, bones, marrow, fat and sperm (\textsl{Suśruta Saṁhitā},\index{Susrutasamhita@\textsl{Suśruta-saṁhitā}} XIV, as cited in Gupt 2006:261).}’ is the term that Dewey lamented did not exist in English, a word that combines both the ‘artistic’ and the ‘aesthetic’ (Thampi 1965). Primarily derived from a reference to cuisine and concept of taste, ‘\textsl{rasa}' can mean essence, gist, or flavor. Bharata Muni\index{Bharatamuni} uses the word as an ‘extract’, since it is ‘worthy of being tasted (Gupt\index{Gupt, Bharat} 2006:261)\endnote{\textsl{Rasaḥ kaḥ padārthaḥ, ucyate āsvādyatvāt} (\textsl{Nāṭyaśāstra} 6:31) (as cited in Gupt 2006:261).} and considers it paramount, for without \textsl{rasa} no other purpose of an art is fulfilled (Rangacharya 1966).  
...
``It is the \textsl{sthāyibhāva} that is arrived at after the first three stages creates a ‘\textsl{rasa}’\,'' (Rangacharya\index{Rangacharya, A} 1966:79). That momentary rest, that the person eating the meal takes before expressing his delight, is the \textsl{sthāyibhāva}---the\index{sthayibhava@\textsl{sthāyibhāva}} moment of total immersion in the experience or enjoyment or reaction is the master, the ruler, and earlier three \hbox{\textsl{bhāva}-s} are subservient, or ‘servants’ (Rangacharya 1966:79) only secondary, to \textsl{rasa}, although all the \textsl{bhāva}-s jointly contribute to the ‘\textsl{rasa}.’\index{rasa@\textsl{rasa}} Since \textsl{sthāyibhāva} is the most dominant among the four, it is considered to constitute the \textsl{rasa}.

Just as mixing different tastes \textsl{rasa} is experienced, similarly mixing different \textsl{bhāva}-s---the \textsl{sthāyibhāva}\index{sthayibhava@\textsl{sthāyibhāva}} is transformed into \textsl{rasa}.\index{rasa@\textsl{rasa}} The success of a performance is determined by the extent of the appreciative spectators relishing a particular \textsl{rasa}. An artist’s ability to create within the boundaries of these rules indicates his ability to create \textsl{rasa} (Schwartz\index{Schwartz, S. L.} 2004). 
...
Malhotra, R. (2011). \textsl{Being Different: An Indian Challenge to Western Universalism}. Noida: Harpercollins India.

\bibitem[]{chap4_item16}
---\kern3pt(2016). “Rajiv Malhotra explains the challenges of understanding Sheldon Pollock.” \textsl{Swarajya}. Online Edition. Accessed on 24th May 2016.
