...
One of the main elements of Pollock’s \textsl{rasa}\index{rasa@\textsl{rasa}} analysis is the identification of a “fundamental” difference between literature-seen and literature-heard (\textsl{dṛśyakāvya}\index{drsyakavya@\textsl{dṛśyakāvya}} and \textsl{śrvyakāvya}).\index{sravyakavya@\textsl{śravyakāvya}} The distinction and its implication on \textsl{rasa} theory\index{rasa theory@\textsl{rasa} theory} is developed in several steps as outlined below (Pollock, 2012):
\begin{enumerate}
\itemsep=1pt
