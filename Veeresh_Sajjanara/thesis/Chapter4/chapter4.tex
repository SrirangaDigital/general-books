\chapter{ws closed and ws open Maps in Topological Spaces}
...
We use example \ref{exam4.2.2} to prove the inverse of theorem is untrue.
...
We use example \ref{exam4.2.3} to prove the inverse of theorem is untrue.

\begin{exm}\label{exam4.2.3}
...
Take up $\TSP=\TSQ= \{1, 2, 3, 4\}$. Let $\tau= \{\varphi, \TSP, \{1,2\}, \{3,4\}\}$ be a topology on $\TSP$ and $\sigma=\{\phi, \TSQ, \{1\}, \{2\}, \{1, 2\},\{1,2,3\}\}$ be a topology on $\TSQ$ and $\ws\TSC(\TSQ)=\{\TSQ, \phi, \{1\},\{2\},\{3\},\{4\},\{1,3\}, \{1,4\},\{2,3\},\{2,4\},\{3,4\},\{1,2,4\},\break \{1,3,4\}, \{2,3,4\}\}$, g\#s$\TSC(\TSQ)=\{\TSQ, \phi, \{2\},\{3\},\{4\},\{2,3\},\{2,4\},\{3,4\},\{2,3,4\}\}$.\break Let $\TSh: (\TSP, \tau ) \to (\TSQ, \sigma)$ be a function defined by $\TSh(1)= 1$, $\TSh(2)=4$, $\TSh(3)=3$, $\TSh(4)=4$, is ws-closed map but not closed as image of closed set $\{1,2\}$ in $\TSP$ is $\{1,4\}$ is not g\#s-closed set in $\TSQ$.
\end{exm}

\begin{thm}\label{thm4.2.4}
...
We use example \ref{exam4.2.5} to prove the inverse of theorem is untrue.

\begin{exm}\label{exam4.2.5} 
...
\begin{proof}
(i) $\Rightarrow$ (ii) obiuosly from Theorem \ref{thm4.2.18}.
...
\section{ws-Open Maps}\label{sec4.3}

\begin{dfn}\label{defi4.3.1}
...
\begin{proof}
Proof is similar to Theorem \ref{thm4.3.5}.
\end{proof}
