...
karxmAgata Gana saMKeyxgaLa motatxvanunx kaMDuhiDiyalu kirx.\hspace{0.1cm}sha.\hspace{0.1cm}\hspace{0.1cm}$476$ ralilxdadx kusumapurada AyaRBaTa oMdu sUtarxvanunx niVDidAdxne. 

AsUtarxveV\quad  $1^{3}+2^{3}+3^{3}+\cdots+n^{3}=\left[\frac{1}{2}n(n+1)\right]^{2}$
\begin{align*}
