...
&=2\times 3\\
&=6 \quad \text{idu paripUNaRsaMKeyx}\\[0.1cm]%Separate para
...
&2^{5-1}(2^{5}-1)\\
&= 16(31)\\ 
&= 496 \qquad\textbf{iduparipUNaRsaMKeyx}\\[0.1cm]  %Separate para
...
yahUdi vaMshasathxnAda nikoVmAkasf eMba girxVsf gaNita shAsatxrXjacnxnige kirx.~sha.\ oMdaneya shatamAnadalilxyeV paripUNaR saMKeyxgaLa bagegx tiLiditatxMte. anaMtara PerxMcf gaNitajacnx  PamaR matutx sivxTajxrfleMDfna gaNitajacnx Ayalxrf kelavu paripUNaR saMKeyxgaLanunx niVDidaru. 
...
6\;\text{neya paripUNaRsaMKeyx} \quad &25898695056
\end{align*}
