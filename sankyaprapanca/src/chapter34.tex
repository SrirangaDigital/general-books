...
S_1 &= \frac{n(n+1)}{2} &\text{{$S_1 =$} karxmAgata saMKeyxgaLu}  
\end{flalign*}
\begin{flalign*}
S_3 &= 1^3+2^3+3^3+4^3+ \ldots n^3&\\
&=\left[\frac{n(n+1)}{2}\right]^2 \qquad\qquad\text{{$S_3 =$} karxmAgata Gana saMKeyxgaLu}\\
\text{AdadxriMda}\qquad\qquad S_3 &= [S_1]^2\\
