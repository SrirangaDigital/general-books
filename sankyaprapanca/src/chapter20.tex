...
%\text{oMdu saMKeyxge matotxMdu saMKeyxyanunx kUDida, motatxvanunx gamanisi.} 
%\end{minipage}
%\begin{minipage}[]{2.5cm}
%\text{oMdu saMKeyxyanunx matotxMdu saMKeyxyiMda guNiside guNalabadhxvanunx gamanisi.
%\end{minipage}
