...
I pusatxkada hasatxparxtiyanunx Odi, tididx, yukatx mAgaRdashaRna niVDida DA.~si.~esf.\break yoVgAnaMda, shirxV.~e.~veMkaTarAmf avarigU, mununxDi niVDiruva\break si.~esf. ~araviMda dheYyaRdiMda parxkaTisalu muMde baMdiruva$\ldots\ldots\ldots\ldots$ nananx\break vaMdanegaLu.

AroVgayxkara salaheyanunx sivxVkarisalu nAnu sadA sidadhx.

\begin{flushright}
{\sl\bfseries {\rm --} veY. ~esf.\ subarxhamxNayx}\\
nivaqtatxgaNitajacnx\\
