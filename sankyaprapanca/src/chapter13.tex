...
$$
$3,4$ matutx $5$ saMKeyxgaLanunx mUla peYthAgorasf saMKeyxgaLu enunxtetxVve. ililx $3$ saMKeyx\-gaLU karxmAgatavAgi baMdive. I guNavanunx hoMdiruva saMKeyxgaLa idoMdeV eMdu kANisutatxde.
$$
a^2+b^2 = c^2
$$
...
$$
a^2+b^2=c^2 \quad\text{sUtarxkekx AdheVshisidare}
$$
\begin{align*}
...
$m=5$ AdAga $5,12,13$ peYthAgorasf saMKeyxgaLu.
...
1\frac{2}{3} = \frac{5}{3} & 5-1=4 & 3,4,5 &{\frac{5}{3}\text{eMbudaralilx aMshavutirxVBujada }}\\ 
...
4\frac{5}{9} = \frac{41}{9}& 41-1=40 & 9,40,41
\end{tabular}
\end{center}
