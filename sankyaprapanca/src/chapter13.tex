...
aMdare ililx $a=m^2-n^2$, $b=2mn$ matutx $c=m^2+n^2$
...
$m=3$ matutx $n=2$ AdAga $a=5$, $b=12$ matutx $c=13$ dorakutatxde. idU saha peYthAgorasf saMKeyxgaLeV. meVle baMdiruva samiVkaraNagaLanunx gamanisidAga eraDu viSayagaLanunx nAvu gamanisabahudu.
