...
\end{figure}
citarxdalilx $Y\times Z$ koVnada parimANaveSuTx? eMdaru utatxra takaSxNa baMdeV baMtu $75^\circ$ eMdu. heVge eMdaru? tirxBujada oMdu bAhuvanunx vaqdidhxsidAga uMTAguva horakoVna aMtasAthxBimuKa koVnagaLa motatxkekx sama. 
\begin{align*}
...
Iga \quad $\bigtriangleup DEO$ \quad nalilx \quad $E\widehat{D}O=110-x$, \quad $D\widehat{O}E=70^\circ$ \quad $D\widehat{E}O=x^\circ$

$x$ ge yAva belekoTaTxrU \quad $\bigtriangleup DEO$ \quad na koVnagaLu tiLiyutatxde. Adare \quad $\widehat{x}$, \quad $o^\circ$ giMta jAsitx irabeVku.
