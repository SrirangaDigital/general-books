...
Adare oMdu AshacxyaRkara saMgati eMdare AyaRBaTa, barxhamxgupatx, mahAviVrA\-cAyaR matutx (eraDaneV) BAsakxrAcAyaRru I mAyAcwkada bagegx parxsAtxpa\-mADilalx.
...
\begin{alignat*}{3}
\text{aDaDxsAlu }\qquad  && 8+1+6&&=15\\[-.1cm]
&&3+5+7&&=15\\[-.1cm]
&&4+9+2&&=15\\[-.1cm]
\text{kaMbasAlu}\qquad  &&8+3+4&&=15\\[-.1cm]
&&1+5+9&&=15\\[-.1cm]
&&6+7+2&&=15\\[-.1cm]
\text{mUleyiMda mUlege} \qquad & & 4+5+6&&=15\\[-0.2cm]
\text{kaNaRsAlu} \qquad  &&\\[-0.6cm]
&&8+5+2&&=15
\end{alignat*}
...
\noindent
udAharaNe $6, 10, 14, 18\ldots\ldots$ ra sherxVNi (dajeR)yavu {\rm 4} riMda BAgavAguvudilalx. $2(2n+1)$ sUtarxdalilx $n=1$ AdAga $6, n=2$ AdAga {\rm 10}, $n=3$ AdAga $14\ldots\ldots$ I riVti 
