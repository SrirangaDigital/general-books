...
\begin{center}
\begin{tabular}{c}
\centering{\includegraphics{src/figures/drawing.eps}}
\end{tabular}
\end{center}
$$
\begin{matrix}
...
saMKeyx $1, 2, 3\ldots\ldots n$ varegina dhanapUNARMkagaLanunx karxmAnusAravAgi vividha sherxVNi (dajeR)gaLalilx mAyAcwkagaLanunx racisidAga avugaLa mAyA motatx $S=\dfrac{n(n+1)}{2}$ Agidadxre adu niyamita mAyAcwka
