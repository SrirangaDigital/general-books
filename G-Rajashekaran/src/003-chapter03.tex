...
\addtocontents{toc}{\protect\contentsline{section}{{\sl V Devanathan}\smallskip}{}}
...
\section[Elementary photopion production cross section]{Elementary photopion production cross\hfil\break section}\label{chap3-sec4}
...
\begin{align}
  ...
  & = \frac{1}{2} \sum_{m)i, m_f} (\langle \tfrac{1}{2}, m_f | \boldsymbol{\sigma \cdot K} + L| \tfrac{1}{2}, m_i \rangle) \langle \tfrac{1}{2}, m_f | \boldsymbol{\sigma\cdot K} + L| \tfrac{1}{2}, m_i \rangle^\dagger \notag\\
...
In Eq.\ \eqref{chap3-eq47},  only quantities that depend on $m_\lambda$ can be pulled out and summation over $m_\lambda$ performed.
\begin{align}
