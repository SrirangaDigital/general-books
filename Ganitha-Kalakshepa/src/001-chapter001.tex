...
\item ಇದು ವರ್ಗ ಸಮೀಕರಣದ ಸಮಸ್ಯೆ ದುಂಬಿಗಳ ಸಂಖ್ಯೆ  $x$ ಇರಲಿ ಅರ್ಧಭಾಗದ ವರ್ಗಮೂಲ $\sqrt{\dfrac{x}{2}}$ ಅಥವಾ $\dfrac{\sqrt{x}}{\sqrt{2}}$ ಒಂಭತ್ತನೆ ಭಾಗದ 8ರಷ್ಟು $\dfrac{8x}{9}$.

 $\dfrac{\sqrt{x}}{\sqrt{2}} + \dfrac{8x}{9} + 1 + 1 = x$ ಸಮೀಕರಣ ಸಿದ್ಧಿಸುತ್ತದೆ. 
\begin{align*}
