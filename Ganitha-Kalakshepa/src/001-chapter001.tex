...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.85]{images/chap1/q10.eps}
\end{figure}

\item 12 ಬೆಂಕಿಕಡ್ಡಿಗಳಿಂದ ಚೌಕ ರಚಿಸಿದೆ. ಯಾವ ಎರಡು ಕಡ್ಡಿ ತೆಗೆದರೆ ಎರಡು ಚೌಕ ಮಾತ್ರ ಉಳಿಯುತ್ತವೆ ?
\begin{figure}[H]
\centering
\includegraphics[scale=.85]{images/chap1/q11.eps}
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.8]{images/chap1/q16.eps}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics{images/chap1/ans22.eps}
\end{figure}
\end{minipage}
\begin{minipage}[c]{5cm}
\begin{tabular}{lr}
...
\begin{figure}[H]
\centering
\includegraphics{images/chap1/ans24a.eps}
\end{figure}
\quad ಅಥವಾ \quad 
\begin{figure}[H]
\centering
