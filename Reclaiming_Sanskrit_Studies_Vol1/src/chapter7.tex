...
In a culture that defines the four valid goals of life\index{valid goals of life} – {\sl dharma,\index{dharma} artha\index{artha@\textsl{artha}}, kāma\index{kāma}}, and {\sl mokṣa\index{mokṣa}}– and where the first three are to be subservient to the last one (even though the fourth is sometimes subsumed under the first), everything is aligned to the last of the {\sl puruṣārtha\index{puruṣārtha}}-s, however mediated the link. 
...
Everything is done for the sake of putting us on the path to this final goal– even {\sl kāma} in its right place, and within bounds leads to that. Each point in time is linked to this ultimate goal, from before birth to beyond death ({\sl niṣekādi-smaśānāntaḥ: Manusmṛti\index{Manusmṛti}} 2.16), and all key actions take the form of {\sl yajña}-s\index{yajña}. Even the consumption of food is linked to the ultimate goal:  
\begin{center}
\begin{tabular}{>{\sl}l}
