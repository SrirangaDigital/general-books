...
\subsubsection{} He then talks of how the past and the present (i.e. mid-17th century CE) subtly but clearly got separated though there was no overt schism between the “{\sl prācya\index{pracya@\textsl{prācya}}}” and “{\sl navya}”\index{pracya and navya@\textsl{prācya and navya}}. To look at the socio-political milieu of scholarship, Pollock picks up two traditional scholars viz. Siddhicandra\index{Siddhicandra} (1587--1666 CE), a Jain monk in the court of Akbar\index{Akbar} and Jahangir\index{Jahangir}, and Kavīndrācārya Sarasvatī\index{Kavindracarya Sarasvati@Kavīndrācārya Sarasvatī} (1600--75), a leading {\sl paṇḍit} of Vārāṇasī\index{Varanasi@Vārāṇasī} -- and contrasts them with Jagannātha.
