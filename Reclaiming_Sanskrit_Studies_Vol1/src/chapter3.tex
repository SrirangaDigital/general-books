...
But the objective finality of Pollock’s thesis is more specific, viz. to blacken the Indian homeland hypothesis\index{Indian homeland hypothesis} by associating it with National-Socialism. Reality, however, is just the opposite: more even than other Europeans, the Nazis espoused and upheld a westerly homeland and the invasion hypothesis\index{invasion hypothesis}. This invasion happens to be a corner-stone of Pollock’s worldview, with invader castes guilty of expropriating and subjugating the natives, who became the lower castes. Hitler-Pollock, same struggle!
