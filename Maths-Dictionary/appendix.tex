...
\vskip .4cm
\centerline{\bf kaMtina vAyxpAra \ \ \eng{Instalment Buying}}
\vskip -.5cm
\begin{align*}
...
\eng{I} & neV & pAdadalilx & nideVRshAMkagaLa & cihenx & $(+,+)$\\[2pt]
\eng{II} & neV & '' & '' & '' & $(-,+)$\\[2pt]
\eng{III} & neV & '' & '' & '' & $(-,-)$\\[2pt]
\eng{IV}  & neV & '' & '' & '' & $(+,-)$
\end{tabular}
...
\vskip -.4cm
\begin{align*}
& (x+a)(x+b)=x^{2}+(a+b)x+ab\\[-1pt]
& (a+b)(a-b)=a^{2}-b^{2}\\[-1pt]
& (x+a)(x+b)(x+c)=x^{3}+x^{2}(a+b+c)+\\[-1pt]
&\hspace{3.6cm} x(ab+bc+ca)+abc\\[-1pt]
& (a+b)^{2}=a^{2}+2ab+b^{2}\\[-1pt]
& (a-b)^{2}=a^{2}-2ab+b^{2}\\[-1pt]
& (a+b+c)^{2}=a^{2}+b^{2}+c^{2}+2ab+2bc+2ca\\[-1pt]
& (a+b)^{3}=a^{3}+3ab(a+b)+b^{3}\qquad\text{athavA}\\[-1pt]
& (a+b)^{3}=a^{3}+3a^{2}b+3ab^{2}+b^{3}\\[-1pt]
& (a-b)^{3}=a^{3}-3ab(a-b)-b^{3}\qquad\text{athavA}\\[-1pt]
& (a-b)^{3}=a^{3}-3a^{2}b+3ab^{2}-b^{3}\\[-1pt]
& (a+b+c)^{3}=a^{3}+b^{3}+c^{3}+3(a+b)(b+c)(c+a)\\[-1pt]
& (a-b)(b-c)(c-a)=a(b^{2}-c^{2})+b(c^{2}-a^{2})+c(a^{2}-b^{2})\\[-1pt]
& \Sigma a^{2}(b-c)=a^{2}(b-c)+b^{2}(c-a)+c^{2}(a-b)\\[-1pt]
& \Sigma a(b+c)=a(b+c)+b(c+a)+c(a+b)\\[-1pt]
& \Sigma ab=ab+bc+ca
\end{align*}
%\begin{center}
...
\eng{triangle}
\end{tabular} &
$A=\dfrac{\sqrt{3}\times a^{2}}{4}$ & \multicolumn{1}{c}{\raisebox{.7cm}{$p=3a$}} & \begin{tabular}[c]{@{\kern -1.5cm}c@{}} \includegraphics[scale=.9]{figures/app03.eps} 
\end{tabular}\\ 
\hline
$3$ & 
\begin{tabular}{l}
...
Gana\\[3pt]
\eng{Cube}
\end{tabular} & $4l^{2}$ & $6l^{2}$ & $l^{3}$ & \begin{tabular}[c]{c}\includegraphics[scale=.9]{figures/app22.eps}\end{tabular}\\
\hline
\end{longtable}
\end{center}
\end{landscape}
...
\begin{tabular}{c|c}
\raisebox{-1cm}{\includegraphics[scale=.9]{figures/app24.eps}}~~~~
& 
