...
$X_2$ hence we have
\begin{equation*}
P(a \in   (X_1,X_2)) = P(X_1 < a,a < X_2) = P(X_1 < a,X_2 > a). \tag{1}
\end{equation*}
...
in the course already. Technically we should think of the formula (1) as the \textit{definition}
...
\begin{equation*}
P(\theta \in  (W_1,W_2)) = 1 - \alpha. \tag{2}
\end{equation*}
If we hadn't given the definition in Equation (1) we wouldn’t have been able to make
the correct definition in Equation (2). If we have an actual sample $x_1, x_2,  \ldots ,x_n$
...
In each case we will verify that the equation (2) is satisfied. It is imperative
