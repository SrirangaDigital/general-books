...
In the \underline{complete gamma function} we integrate from $0$ to \underline{infinity} whereas for the \underline{incomplete gamma function} we integrate from $0$ to $\underline{x}$.
$$
