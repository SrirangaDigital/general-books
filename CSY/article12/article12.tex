...
\end{equation*}
But $X$ is discrete and $Y$ is continuous so $X$ could assign a non-zero probability to the end $a$ and to the other end $b$ ?????? $X$ {\it would assign zero probability to each end.}
