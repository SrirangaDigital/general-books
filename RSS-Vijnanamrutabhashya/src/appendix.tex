...
Thus in the first half of the verse “te dhyānayogānugatā apaśyan devātmaśaktim svaguṇairnigūḍhām” (ibid. I.3) knowing one’s own power is mentioned at first (ādau śaktidarśanamuktam) ; one should think that this is for  indicating being the support which possesses the power (tacchaktimato’dhiṣṭhātṛtvadarśanopayogitayeti mantavyam; if it is to be known independently then the mention of possessing the power is not reasonable (svatantrajñeyatve śaktitvavacanānupapattiriti);
...
By splitting the word as ‘virodha’ (antaram) (the next sūtra) follows (anuvartate). Or it is a separate word meaning rejection in the previous sūtra (athavā pūrvasūtre niṣedhārthakapṛthakpadameva vā).
...
Ans: Because of the statement “ekamajām bahvīḥ prajāḥ sṛjamānāmit”.
...
We will now discuss this: Pradhāna, through being the power of Īśvara through inference is mentioned as the creator of the world. Is   this the same as the minister is (the support) for the king, as the internal organ is (the support) for the jīva, being the support for the decisions etc., of pramātman by prakṛti called natural inclination (kimetadeva rājño mantrivajjīvasyāntaḥkaraṇavacca paramātmanaḥ saṃkalpādyādhārabhūtā svabhākhyā prakṛtirantaraṅgaśaktiḥ). Or is this external power situated in the body that of Īśvara alone and is a separate power of Īśvara. Or is it like Īśvara by itself, without dependence on any other power, similar to (Īśvara) mentioned by the Nayāyikas rules over pradhāna and puruṣa (kim vā śaktyantaranairapekṣyeṇaiva naiyārikānāmiva svata eveśvaraḥ pradhādhānapuruṣādikam adhitiṣṭati iti?)\footnote{The last option is attributing Īśvara’s power independently to influence both puruṣa and prakṛti in the process of creation.}
