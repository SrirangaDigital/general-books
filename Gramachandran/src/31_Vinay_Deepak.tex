\chapter[Professor Gowravaram Ramachandran: A Fine\hfil\break Gentleman, Inspiring Teacher and A Passionate Scientist]{Professor Gowravaram Ramachandran: A Fine Gentleman, Inspiring Teacher and A Passionate Scientist}\label{chap31}

\Authorline{H S Vinay Deepak\footnote[*]{Email: \url{vinaydee@gmail.com}}}
\addtocontents{toc}{\protect\contentsline{section}{{\sl H S Vinay Deepak}\smallskip}{}}
\authinfo{Professor, BASE Educational Services Pvt. Ltd., Bengaluru}
\lhead[\small\thepage]{\small\thechapter. A Fine Gentleman, Inspiring Teacher and A Passionate Scientist}
...
My research involved both pure liquid crystalline materials as well as molecules oriented in liquid crystalline matrices \cite{chap31-key3,chap31-key16}.  Research investigations were related to assignment of resonances in partially ordered systems and director dynamics of spinning liquid crystals in different phases exhibiting various phase symmetries, eventually leading to novel techniques and methodologies. Simplified methods for structure determination of solutes dissolved in liquid crystal solvents have been proposed. Diffusion ordered spectroscopy of a mixture of liquid crystals of opposite diamagnetic susceptibility at its coexistent phase was also used and studied, besides chiral discrimination using an\-iso\-tropic NMR interactions with particular emphasis in bio-molecular applications.
