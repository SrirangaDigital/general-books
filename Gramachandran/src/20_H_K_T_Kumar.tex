...
\Authorline{H K T Kumar\footnote[*]{Email: \url{hktkumara@gmail.com}}}
\addtocontents{toc}{\protect\contentsline{section}{{\sl H K T Kumar}\smallskip}{}}
...
\centerline{\includegraphics[scale=1.3]{authorsphotos/Prof_H_K_T_Kumar.eps}}
\bigskip
