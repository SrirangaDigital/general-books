...
\lhead[\small\thepage]{\small\it\thechapter. Majorana geometric representation of permutation...}
\rhead[\small\it\thechapter. Majorana geometric representation of permutation...]{\small\thepage}
...
%25
\bibitem{Niel} M. Nielsen and I. Chuang, {\em Quantum Computation and Quantum Information} (Cambridge University Press,
Cambridge, UK, 2000)
%26
...
\clineB{1-2}{2.5}
 &\\
\raisebox{-2.4cm}{\includegraphics[scale=1.2]{figures/authors/Prof_A_R_Sudha.eps}} & 
...
\clineB{1-2}{2.5}
 ...
 &\\
\raisebox{-3.1cm}{\includegraphics[scale=.65]{figures/authors/Prof_A_R_Usha_Devi.eps}} & 
...
\clineB{1-2}{2.5}
 ...
 &\\
\raisebox{-3.1cm}{\includegraphics[scale=.1]{figures/authors/A_K_RajaGopal.eps}} & 

\centerline{\large\bf A. K. Rajagopal}

\bigskip
Authors Details not Avialable\\
&\\ 
\clineB{1-2}{2.5}
\end{tabular}
