\chapter[Majorana geometric representation of permutation\hfil\break symmetric pure multiqubit states]{Majorana geometric representation of permutation symmetric pure multiqubit states}\label{chap29} 

\renewcommand{\thefootnote}{\fnsymbol{footnote}}

\Authorline{Sudha,$^{1,2,}$\footnote[*]{Email: \url{arss@rediffmail.com}}
A R Usha Devi,$^{3,2,}$\footnote[$\dagger$]{Email: \url{arutth@rediffmail.com}; \url{ushathirthahalli@gmail.com}} and 
A K Rajagopal$^{2,}$\footnote[$\ddagger$]{Email: \url{attipat.rajagopal@gmail.com}}}
\addtocontents{toc}{\protect\contentsline{section}{{\sl Sudha, A R Usha Devi } and {\sl A K Rajagopal}\smallskip}{}}
\lhead[\small\thepage]{\small\thechapter. Majorana geometric representation...}
...
\section[Majorana geometric representation of permutation\hfil\break symmetric multiqubit pure states]{Majorana geometric representation of permutation symmetric multiqubit pure states}\label{chap29-secII} 
...
\begin{equation}
\vert \Psi^{(N)}_{\rm sym}\rangle={\cal N}_N\, \sum_{P}\, \hat{P}\, \Bigl\{\vert \epsilon_1, \epsilon_2, \ldots  \epsilon_N \rangle\Bigr\}, \label{Maj}
\end{equation} 
...
{\biofntsize\textbf{Dr.\ Sudha} obtained the M.Sc.\ degree in 1990 and Ph.D. in 1999 from Mysore University. She joined the Physics Department, Kuvempu University, Shimoga, in 2006, where she is currently Associate Professor.}
\end{minipage}
\vskip 1cm
...
{\biofntsize\textbf{Dr.\ A. R. Usha Devi} obtained the M.Sc.\ degree in 1990 and Ph.D. in 1998 from Mysore University. She worked for Ph.D. under the guidance of Prof.\ G. 
...
\begin{minipage}[t]{3cm}%
\phantom{i}\\[-3.2cm]%
\includegraphics[scale=0.65]{authorsphotos/A_K_RajaGopal1.jpg}
\end{minipage}
\begin{minipage}{6.8cm}
{\biofntsize\textbf{Professor A. K. Rajagopal} got his Ph.D. degree in 1964 from Harvard University, USA. He worked as a Professor at the Department of Physics, Louisiana State University, USA, for more than a decade. Then he joined Naval Research Laboratory (NRL), Washington D.C., USA, as a Research Physicist in 1985. He retired from NRL in 2006.  Prof.\ Rajagopal has contributed more than 325 research papers on a variety of topics in Condensed Matter Theory, Quantum Statistical Physics, Foundational Issues of Quantum Theory and Quantum Information Processing. He is a Fellow of the American Physical Society and a Fellow of the Washington Academy of Science. He has now settled down in Mysuru and is actively engaged in research.}
\end{minipage}
