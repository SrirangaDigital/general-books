\chapter[Majorana geometric representation of permutation...]{Majorana geometric representation of permutation symmetric pure multiqubit states}\label{chap29} 

\renewcommand{\thefootnote}{\fnsymbol{footnote}}

\Authorline{Sudha,$^{1,2,}$\footnote{arss@rediffmail.com} A. R. Usha Devi,$^{3,2,}$\footnote{arutth@rediffmail.com} and A. K. Rajagopal$^{2,}$\footnote{attipat.rajagopal@gmail.com}}
...
\centerline{\includegraphics[scale=1.2]{authorsphotos/Prof_A_R_Sudha.eps}}
\smallskip
...
\centerline{\includegraphics[scale=.65]{authorsphotos/Prof_A_R_Usha_Devi.eps}}
\smallskip 

\authbio{A. R. Usha Devi}
\bigskip
