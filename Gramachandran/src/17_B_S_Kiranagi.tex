...
\Authorline{B S Kiranagi\footnote{Adjunct Professor, Mangalore University, Mangalagangotri. (Dedicated to the affectionate memory of G, Ramachandran)}}

\authinfo{Retired Professor, Department of Mathematics\\
...
\centerline{\includegraphics[scale=.5]{authorsphotos/Prof_B_S_Kiranagi.eps}}
\bigskip
