\chapter[Deuteron Photodisintegration and its application to\hfil\break Astrophysics]{Deuteron Photodisintegration and its application to Astrophysics}\label{chap34}

\Authorline{S P Shilpashree\footnote[*]{Email: \url{shilpashreesp@gmail.com}}}
\addtocontents{toc}{\protect\contentsline{section}{{\sl S P Shilpashree}\smallskip}{}}
\authinfo{School of Engineering and Technology,\\ 
CHRIST (Deemed to be University)\\
Bangalore}
\lhead[\small\thepage]{\small\thechapter. Deuteron Photodisintegration and its application to Astrophysics}
