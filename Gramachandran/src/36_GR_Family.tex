...
\centerline{\includegraphics[scale=0.08]{src/images/2020.jpg}}
\vfill

\begin{minipage}{4cm}
\centerline{\includegraphics[scale=0.8]{src/images/1990s.jpg}}
\end{minipage}
\begin{minipage}{6cm}
\centerline{\includegraphics[scale=0.08]{src/images/2006.jpg}}
\bigskip

\centerline{\includegraphics[scale=0.53]{src/images/1980s.jpg}}
\end{minipage}

%~ \begin{tabular}{@{}p{5cm}p{6cm}@{}}
%~ \multirow{2}{4cm}{\includegraphics[scale=0.6]{src/images/1990s.jpg}\\\phantom{\rule{2pt}{2cm}}} & \includegraphics[scale=0.07]{src/images/2006.jpg}\tabularnewline
 %~ & \includegraphics[scale=0.6]{src/images/1980s.jpg}
%~ \end{tabular}


%~ \centerline{\includegraphics[scale=0.1]{src/images/2006.jpg}\quad\includegraphics[scale=0.935]{src/images/1990s.jpg}}
%~ \smallskip

%~ \centerline{\includegraphics[scale=0.6]{src/images/1980s.jpg}}
