\chapter[G R – A Memorable Colleague]{G R – A Memorable Colleague}\label{chap1}

\Authorline{Professor P. Venkataramaiah}
\smallskip

\authinfo{Department of Physics,UOM\\
...
\centerline{\includegraphics[scale=1.1]{authorsphotos/Prof_P_Venkataramaiah.jpg}}
\smallskip

\authbio{Prof.\ P.\ Venkataramaiah}
\bigskip
