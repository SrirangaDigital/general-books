...
space as:
  ...
  \begin{align}
      ...
      G_M^{p(n)}(q^2)=\frac{1+\mu_p(\mu_n)}{(M_v^2 - q^2)^2} , \label{chap9-eq7}
  \end{align} 
\noindent
...
\hline
&&\\[-0.2cm]
down-quark (d) & $-\frac{1}{2}+3\sin^2\theta_W$ & -$\frac{1}{2}$\\[-0.2cm]
&&\\
\hline
 \end{tabular}
...
There have been quite a few experiments done on various targets like proton, $^4{He}$ and $^{12}{C}$ with polarized electrons beam at MAINZ, MIT-Bates and JLAB during the last 20 years and the results are given in Table II \cite{key22}.
\begin{center}
\begin{tabular}{|c|c|}
 \hline
...
\medskip
 ...
 {Table II: Results from selected parity violating~(PV) in elastic experiments. Asymmetries are given in parts per million~(ppm).}
%\label{chap9-tab2}
\end{center}
...
\end{center}
\begin{equation}
{\cal L}^{eq}_{PV}= \frac{G_F}{\sqrt{2}}\Big[\bar{e}\gamma^\mu \gamma_5 e \sum_{q=u,d} c_1^q\bar{q}\gamma_\mu q +\bar{e}\gamma^mu e  \sum_{q=u,d} c_2^q\bar{q}\gamma_\mu \gamma_5 q\Big] \label{chap9-eq33}
\end{equation}
and the values of $c_1$ and $c_2$ is given in Table IV.
\begin{center}
\begin{tabular}{|c|c|c|}
 \hline
\backslashbox{Quarks}{Coefficients} & $c_1$&$c_2$ \\
 \hline
...
{Table V: Results from selected PV in Deep inelastic  experiments. Asymmetries are given in ppm.}

\end{center}


The recent experiment at JLab also covers a wide range of the COM energy W extending from the $\Delta$ resonance to DIS region demonstrating the validity of the Standard Model in the transition or shallow inelastic scattering (SIS) region as well as in the deep inelastic scattering region \cite{key28}.
...
\bibitem{key1} F. J. Hasert {\it et al.} [Gargamelle Neutrino Collaboration], Phys.\ Lett.\  {\bf 46B}, 138 (1973).  
\bibitem{key2} S. Weinberg,Phys.\ Rev.\ Lett.\  {\bf 19}, 1264 (1967).
\bibitem{key3} A. Salam,  Conf.\ Proc.\ C {\bf 680519}, 367 (1968).
\bibitem{key4} C. Y. Prescott {\it et al.}, Phys.\ Lett.\  {\bf 77B}, 347 (1978).
\bibitem{key5} C.~Y.~Prescott {\it et al.}, Phys.\ Lett.\  {\bf 84B}, 524 (1979).
\bibitem{key6} G.~Ramachandran and S.~K.~Singh, Phys.\ Rev.\ D {\bf 18}, 1441 (1978).
\bibitem{key7} M.~V.~N.~Murthy, G.~Ramachandran and S.~K.~Singh, Phys.\ Lett.\  {\bf 81B}, 129 (1979).
\bibitem{key8} S.~K.~Singh and S.~A.~Khan, Nucl.\ Phys.\ A {\bf 340}, 307 (1980).
\bibitem{key9} M.~V.~N.~Murthy, G.~Ramachandran and S.~K.~Singh, Pramana {\bf 20}, 221 (1983).
\bibitem{key10} M.~V.~N.~Murthy, G.~Ramachandran and S.~K.~Singh, Z.\ Phys.\ A {\bf 306}, 117 (1982).
\bibitem{key11} H.~Arenhovel and S.~K.~Singh, Eur.\ Phys.\ J.\ A {\bf 10}, 183 (2001).
\bibitem{key12} S.~Ahmad, S.~K.~Singh and H.~Arenhovel, Eur.\ Phys.\ J.\ A {\bf 40}, 151 (2009).
\bibitem{key13} F.~Akbar, M.~Sajjad Athar, A.~Fatima and S.~K.~Singh, Eur.\ Phys.\ J.\ A {\bf 53}, no. 7, 154 (2017).
\bibitem{key14} A.~Fatima, M.~Sajjad Athar and S.~K.~Singh, Eur.\ Phys.\ J.\ A {\bf 54}, no. 6, 95 (2018).
\bibitem{key15} A.~Fatima, M.~Sajjad Athar and S.~K.~Singh, Phys.\ Rev.\ D {\bf 98}, no. 3, 033005 (2018).
\bibitem{key16} M.~S.~Athar and S.~K.~Singh, ``The Physics of Neutrino Interactions,'' Cambridge University Press, 2020,  doi:10.1017/9781108489065
\bibitem{key17} K. Abe et. al. for The T2K Collaboration, Nature, {\bf 580}, 339 2020.
\bibitem{key18} R.~Prepost, R.~M.~Simonds and B.~H.~Wiik, Phys.\ Rev.\ Lett.\  {\bf 21}, no. 17, 1271 (1968).
\bibitem{key19} S.~Rock {\it et al.}, Phys.\ Rev.\ Lett.\  {\bf 24}, 748 (1970).
\bibitem{key20} G.~Ramachandran, Nucl. Phys. B \textbf{2}, 565-580 (1967) doi:10.1016/0550-3213(67)90191-5
\bibitem{key21} T.~Frederico, E.~M.~Henley and G.~A.~Miller, Nucl. Phys. A \textbf{533}, 617-641 (1991) doi:10.1016/0375-9474(91)90536-F
\bibitem{key22}  J.~Erler, C.~J.~Horowitz, S.~Mantry and P.~A.~Souder, Ann.\ Rev.\ Nucl.\ Part.\ Sci.\  {\bf 64}, 269 (2014)   doi:10.1146/annurev-nucl-102313-025520  [arXiv:1401.6199 [hep-ph]].
\bibitem{key23} D.~Balaguer Ríos {\it et al.}, Phys.\ Rev.\ D {\bf 94}, no. 5, 051101 (2016).   doi:10.1103/PhysRevD.94.051101
\bibitem{key24} T.~M.~Ito {\it et al.} [SAMPLE Collaboration], Phys.\ Rev.\ Lett.\  {\bf 92}, 102003 (2004).
\bibitem{key25} D.~Androic {\it et al.} [G0 Collaboration], Phys.\ Rev.\ Lett.\  {\bf 108}, 122002 (2012).
\bibitem{key26} R.~N.~Cahn and F.~J.~Gilman, Phys.\ Rev.\ D {\bf 17}, 1313 (1978).
\bibitem{key27} E.~Derman and W.~J.~Marciano, Annals Phys.\  {\bf 121}, 147 (1979).
\bibitem{key28} D. Wang et. el. for Jefferson Lab PVDIS Collaboration,   Nature {\bf 506} no. 7486, 67-70 (2014). 
\bibitem{key29} P.~L.~Anthony {\it et al.} [SLAC E158 Collaboration], Phys.\ Rev.\ Lett.\  {\bf 95}, 081601 (2005). 
\bibitem{key30} I.~J.~R.~Aitchison and A.~J.~G.~Hey, ``Gauge theories in particle physics: A practical introduction. Vol. 2: Non-Abelian gauge theories: QCD and the electroweak theory,'' Taylor \& Francis, 2004 
\bibitem{key31} J.~Bernstein, G.~Feinberg and T.~D.~Lee, Phys.\ Rev.\  {\bf 139}, B1650 (1965).
\bibitem{key32} N.~Christ and T.~D.~Lee, Phys.\ Rev.\  {\bf 143}, 1310 (1966).
\end{thebibliography}
...
\clineB{1-2}{2.5}
 &\\
\raisebox{-3.6cm}{\includegraphics[scale=.6]{figures/authors/Prof_S_K_Singh.eps}} & 

\centerline{\large\bf Prof. S. K. Singh}

\bigskip
Dr.~Shri Krishna Singh did his Ph.D. in\break 1972 from Carnegie-Mellon University, Pittsburgh, USA, under Prof. Lincoln Wolfenstein. He was a faculty member of the Department of Physics, Aligarh Muslim University, Aligarh, for more than four decades. He served with distinction as Vice Chancellor of Hemwati Nandan Bahuguna Garhwal University, a Central University in Srinagar, Uttarakhand, for two consecutive terms. Currently he is Professor Emeritus at AMU, Aligarh.\\
&\\ 
\clineB{1-2}{2.5}
\end{tabular}
