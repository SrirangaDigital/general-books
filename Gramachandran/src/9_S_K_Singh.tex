...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{src/images/chap9/fig1.jpg}
...
\end{equation}
 which is given by ${\cal A}_{LR}=-\frac{G_F Q^2}{4\sqrt{2}\pi\alpha}F^p(E_e,q^2)$ for proton target and $F^p(E_e,q^2)$ is given as\cite{chap9-key16}
 \begin{equation}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{src/images/chap9/lambda.jpg}
\includegraphics[scale=0.3]{src/images/chap9/lambda.jpg}
