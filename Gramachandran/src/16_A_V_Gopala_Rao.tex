\chapter[On the Newtonian spacetime and a 4-vector formulation\hfil\break of the Newton law of motion]{On the Newtonian spacetime and a 4-vector formulation of the Newton law of motion}\label{chap16}

\Authorline{A V Gopala Rao\footnote[*]{Email: \url{garakali@gmail.com}}}
\addtocontents{toc}{\protect\contentsline{section}{{\sl A V Gopala Rao}\smallskip}{}}

\authinfo{Department of  Studies in Physics,\\
University of Mysore, Manasagangotri,\\
Mysuru 570006, India
}
\lhead[\small\thepage]{\small\thechapter. On the Newtonian spacetime and a 4-vector formulation...}
...
To illustrate  our  discussion, we  consider motion of a particle relative to an  \textsl{accelerated reference frame} $\{\bar{x}^i\}$ obtained by  a coordinate transformation of the type \eqref{chap16-eq5a}: 
\begin{equation}
