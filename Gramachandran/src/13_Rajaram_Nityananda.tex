...
making up a torus $S^1 \times S^1$. Only one circle is shwn in the figure and the others
...
{} \hspace{1.5cm} ``sourthern" $y L \leq  0$ \quad  $x^2_R + y^2_R + x^2_L = 1 - y^2_L \leq 1$
\begin{figure}[H]
\centering
