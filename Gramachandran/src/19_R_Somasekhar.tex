...
\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{src/images/chap8/2.eps}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{src/images/chap8/3.eps}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{src/images/chap8/4.eps}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{src/images/chap8/5.eps}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale=0.45]{src/images/chap8/6.eps}
\end{figure}
\begin{figure}[H]
\centering
...
\centerline{\includegraphics[scale=.8]{authorsphotos/Somasekhar1.png}}
\bigskip

\noindent
{\biofntsize\textbf{Dr.\ R. Somasekhar} obtained the M.Sc.\ degree in 1975 and Ph.D. in 1982, both from Physics Department, Mysore University. 
