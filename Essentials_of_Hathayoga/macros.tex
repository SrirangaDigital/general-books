...
\long\def\bookTitle#1{\vfill\centerline{{\fontsize{22}{24}\selectfont\textbf{#1}}}\vfill}
\def\titleauthor#1{{\Large\textbf{#1}}}
...
\newenvironment{shloka}{\bgroup\centering\fontsize{11pt}{14pt}\selectfont}{\par\egroup}
