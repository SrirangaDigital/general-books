...
\caption{\textit{Map showing Iron Age sites}}\label{chapter1-fig002}
\end{figure}
...
\end{figure}
\begin{figure}[H]
\includegraphics[scale=.7]{images/chapter-1/fig004.jpg}
\caption{\textit{Key to Fig. 3 (After Chakrabarti 1992 Fig. 13)}}\label{chapter1-fig004}
\end{figure}
