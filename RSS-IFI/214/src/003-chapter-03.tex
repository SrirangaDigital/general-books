...
\caption{Cluster of furnaces, Latif  Shah, Period II}\label{chapter-3-fig6A}
\end{figure}

\begin{figure}[H]
\renewcommand{\thefigure}{6B}
\includegraphics[scale=1.5]{images/chapter-3/fig006b.jpg}
\caption{6 A: Cluster of furnaces, Latif  Shah, Period II.}\label{chapter-3-fig6B}
\end{figure}

\begin{figure}[H]
\renewcommand{\thefigure}{7A}
\includegraphics[scale=.5]{images/chapter-3/fig007a.jpg}
\caption{Latif Shah, No. 210 Surgical Knife, NBPW Pd. III }\label{chapter-3-fig7A}
\end{figure}

\begin{figure}[H]
\renewcommand{\thefigure}{7B}
\includegraphics[scale=0.22]{images/chapter-3/fig007b.jpg}
\caption{Latif Shah, NBPW  Pd. III Iron Age}\label{chapter-3-fig7B}
\end{figure}
