...
\begin{figure}[H]
\includegraphics[scale=.65]{images/chapter-3/fig002a.jpg}
...
\begin{figure}[H]
\setcounter{figure}{4}
\includegraphics[scale=.85]{images/chapter-3/fig002c.jpg}

\vspace{-.2cm}

\caption*{Fig~:~5~A, B, C \textit{Iron-smelting furnaces (reconstructed ancient furnaces)}}
\end{figure}
...
\caption*{Fig~:~6B. LTS Pd. I Iron Age}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=.5]{images/chapter-3/fig007a.jpg}
\caption*{Fig~:~7A. LTS 210 Surgical Knife Pd. III (1)}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.22]{images/chapter-3/fig007b.jpg}
\caption*{Fig~:~7B. LTS Pd. I Iron Age}
\end{figure}
