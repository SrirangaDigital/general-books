...
\caption{(A) Some Recent $^{14}{\rm C}$ Dates of Early Iron Age}\label{table III.1(A)}\\
\hline
...
\caption{{\fontsize{9}{11}\selectfont Radiocarbon and TL Dates of NBP Ware and Early Iron Sites\\
