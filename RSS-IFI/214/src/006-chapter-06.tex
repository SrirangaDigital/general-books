...
Till 1855 there were approximately 121 furnaces which were func-\break tional in Uttarakhand. Area-wise and category-wise distribution of these working units can be understood from the following Table:

\vspace{-.3cm}

{\fontsize{10}{12}\selectfont\begin{longtable}{|l|c|c|c|}
...
\subsection*{I.xiii.  Central Provinces\endnote{The names of the provinces have been retained here as per old records.}\\ (Madhya Pradesh and Adjascent Parts)}\label{subsection-13}
...
{\fontsize{10}{12}\selectfont\begin{center}
\begin{tabular}{|l|l|}
\hline
& Per cent.\\
\hline
...
{\fontsize{8}{10}\selectfont\begin{longtable}{|p{3cm}|c|c|c|c|c|c|}
\hline
