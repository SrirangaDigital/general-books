...
The fourteen \textit{vidyā–sthāna}–s include the four \textit{Veda}–s along with the six \textit{Vedāṅga}–s\endnote{ The six are the followng: \textit{śikṣā}, \textit{vyākaraṇa}, \textit{chandas}, \textit{nirukta}, \textit{kalpa} and \textit{jyotiṣa}.}, Mīmāṁsā, \textit{Nyāyavistara}, \textit{Purāṇa}–s and Dharmaśāstra.
