...
Pollock provides one more example to illustrate the method of comprehending a text along the three dimensions. The meaning of Kālidāsa’s \textit{Abhijñāna–śākuntala}\index{Kalidasa@Kālidāsa}\index{Abhijnana-sakuntala@\textit{Abhijñāna-śākuntala}}\index{Śākuntala@\textit{See Abhijñāna-śākuntala}} along the three planes is now discussed.
...
\subsection*{4.5.1 {\it {\bfseries Pratijñā}}\index{pratijna@\textit{pratijñā}}\endnote{\textit{Pratijñā} – \textit{Nyāyasūtra} 1.1.33 \begin{verse}
