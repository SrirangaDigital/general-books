...
\item Plane 3:\index{Third Dimension/Presentist/Plane 3} the \textit{Śākuntala}\index{Abhijnana-sakuntala@\textit{Abhijñāna-śākuntala}} is ultimately a political text: No \textit{pramāṇa} from the text is shown.
 ...
 \item Plane 2:\index{Second Dimension/Traditional/Plane 2} the \textit{Śākuntala} is not seen as political–by the commenta-\break tors–a traditional verse representing the oral\index{oral tradition} tradition, Goethe\index{Goethe} and Rabindranath Tagore\index{Tagore, Rabindranath}.
...
\begin{myquote}
The intractable antinomy of process and system is well described by Andrew Feenberg, \textit{Lukacs, Marx\index{Marx, Karl} and the Sources of Critical Theory}…My basic conclusion about the denial of history is at odds with the thesis of Claude Lefort (“Outline of the Genesis of Ideology in Modern Societies”) …which seeks to restrict such a denial to modern society. \textbf{My work has been much influenced}, however, by his characterization of ideology as a ``sequence of representations which have the function of re–establishing the dimension of \textbf{`society without history'}…" (1989a: 610fn.)
\end{myquote}
