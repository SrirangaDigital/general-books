...
In order to show that the \textit{Rāmāyaṇa} was written with a political intent, it is placed in a post–Aśokan time frame in the historical plane.
...
\subsection*{4.5.1 {\it {\bfseries Pratijñā}}\endnote{\textit{Pratijñā} – \textit{Nyāyasūtra} 1.1.33 \begin{verse}
...
\subsection*{4.5.2 {\it {\bfseries Hetu}}\endnote{ \textit{Hetu – Nyāya–sūtra} 1.1.34–35
...
\subsection*{4.5.4 {\it{\bfseries Upanaya}}\endnote{ \textit{Upanaya – Nyāya–sūtra} 1.1.38\\
...
\subsection*{4.5.5 {\it {\bfseries Nigamana}}\endnote{ \textit{Nigamana} – \textit{Nyāya–sūtra} 1.1.39\\
