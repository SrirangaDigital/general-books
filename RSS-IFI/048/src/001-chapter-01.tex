...
Most compositions of Dīkṣita are set in \textit{viḷamba-kāla}\index{vilambakala@\textit{vilamba kāla}} (slow tempo).\index{tempo@tempo} This gives an opportunity to listeners to understand the meaning of \textit{sāhitya} and enjoy the music and mental peace that music can give.
...
\subsubsection*{2.2.2.3. \textit{Prāsa}\index{prasa@\textit{prāsa}}\index{prasa - prathamaksara - dvitiyaksara@\textit{prāsa - prathamākṣara - dvitīyākṣara}}}
...
\index{tantra-sastra@\textit{tantra-śāstra}}\index{mantrasastra@mantra-śāstra}Dīkṣita was an ardent \textit{Śrīvidyā-upāsaka} and an intense devotee of Devī. He was a master of \textit{tantra} and of \textit{yantra-pūjā.}\index{puja@\textit{pūja}} There are built in \textit{mantra-s} in many of his \textit{kṛti\index{krti@\textit{kṛti}}-s}.
...
The Dhrupad way of elaboration appears to have captured his imagination while handling compositions in Karnatic\index{Karnatic@Karnatic} \textit{rāga-s} too, by way of elaborate beginning of the composition, the \textit{tempo}\index{tempo@tempo} of his songs being mostly in \textit{viḷamba-kāla}\index{vilambakala@\textit{vilamba kāla}} (slow, measured and majestic), rich in \textit{gamaka,}\index{gamaka@\textit{gamaka}} just as the sliding \textit{mīṇḍ-s} in Hindustani music, as is seen, for instance, in the grandeur and slow paced majesty of \textit{Akṣayaliṅga Vibho} (in \textit{rāga} Śaṅkarābharaṇa)in contemplation of Lord Śiva, or in \textit{Bālagopāla} (in \textit{rāga} Bhairavī)\textit{\textbf{, }}portraying the delight and beauty of the divine child Kṛṣṇa, the \textit{kṛti Nīrajākṣi Kāmākṣi} (in \textit{rāga} Hindoḷa) and so on.
...
\itemsep=1pt
 ...
 \bibitem{chap1-key05} Ayyar, B. Rajam., and Ramanathan, S. (Ed.s) (1968). \textit{Saṅgīta Sampradāya Pradarśini}. Madras: The Music Academy.

 \bibitem{chap1-key06} \textbf{\textit{Chāndogya Upaniṣad}}. See Svami Swaahaananda (2007).

 \bibitem{chap1-key07} Ganapathi. Ra. (1976). \textit{Deivaththin Kural, Vol 1.} Chennai: Vanathi Padhippagam.

 \bibitem{chap1-key08} Govinda Rao, T.K. (1997). \textit{Compositions of Muttusvāmi-Dīkṣita}. Chennai: Ganamandir Publications.

 \bibitem{chap1-key09} Janaki S. S.\index{Janaki S. S.@Janaki S. S.} (2012). \textit{Saṁskṛita and Saṅgīta}. Chennai: The Kuppuswami Sastri Research Institute.

 \bibitem{chap1-key10} Kashyap, R. L. (Ed.) (2003). \textit{Rig Veda Mantra Samhitā}. Bangalore: Sri Aurobindo Kapali Sastry Institute of Vedic Culture.

 \bibitem{chap1-key11} \textbf{\textit{Muṇḍaka Upaniṣad}}. See Ashutoshananda Swami (2002).

 \bibitem{chap1-key12} Pansikar, W. L. (Ed.) (1926). \textit{Yājñavalkyasmṛti with Mitākṣarā of Vijñāneśvara}. Bombay: Nirnaya Sagar Press.

 \bibitem{chap1-key13} Paramarthananda Svami. (2000). \textit{Muṇḍaka Upaniṣad} (Tr.). Chennai: Yogamalika.

 \bibitem{chap1-key14} —. (2005). \textit{Introduction to Vedānta}. Chennai: Yogamalika.

 \bibitem{chap1-key15} —. (2005). \textit{Taittirīya Upaniṣad} (Tr.). Chennai: Yogamalika.

 \bibitem{chap1-key16} Raghavan, V.\index{Raghavan, V.@Raghavan, V.} (1975). \textit{Muttusvāmi Dikshitar.} Bombay: National Center for the Performing Arts.

 \bibitem{chap1-key17} —. (1980). \textit{Śrī Muttusvāmi-Dīkṣita}-\textit{Caritam Mahākāvyam}. Madras: Punarvasu.

 \bibitem{chap1-key18} —. (2018). \textit{Collected Writings on Indian Music}. Chennai: Dr. Raghavan Centre For Performing Arts.

 \bibitem{chap1-key19} Raja, C. Kunhan. (Ed.) (1933). \textit{Un-published Upanishads.} Chennai: Adyar Library.

 \bibitem{chap1-key20} \textbf{\textit{Ṛg Veda.}} See Kashyap (2003).
 
 \bibitem{chap1-key21} \textbf{\textit{Saṅgīta Sampradāya Pradarśini}}.  See Ayyar and Ramanathan (1968).

 \bibitem{chap1-key22} Saxena, Prashant. (2011). “Idol Worshipping, Western Terminologies and the Modern view”. $<$\url{https://www.chakranews.com/idol-worshipping-western-terminologies-and-the-modern-view/1131}$>$. Accessed on 30 Oct 2019.

 \bibitem{chap1-key23} Sridhar, Nithin. (2015). “Fallacies in the criticism of Idol worship”.\\ $<$\url{https://www.academia.edu/25108638/Fallacies_in_the_Criticism_of_Idol_Worship}$>$. Accessed on 30 Oct 2019.

 \bibitem{chap1-key24} Srivatsa, V. V.\index{Srivatsa, V. V.@Srivatsa, V. V.} (2000). \textit{Bhāva-Rāga-Tāla-Modini}. Chennai: Guruguhanjali.

 \bibitem{chap1-key25} Subbarāma-Dīkṣita. See Ayyar and Ramanathan (1968).

 \bibitem{chap1-key26} \textbf{\textit{Sūryatāpinyupaniṣad}}. See Raja (1933).

 \bibitem{chap1-key27} Svami Swaahaananda. (2007).\textit{ Chāndogya Upaniṣad}. Chennai: Rama\-krishna Math.

 \bibitem{chap1-key28} \textbf{\textit{Taittirīya Upaniṣad}} (with \textit{Sāṅkara Bhaṣyam}). (2012). Gorakhpur: Gītā Press.

 \bibitem{chap1-key29} \hspace{.5cm}See Ashutoshananda Swami (2002).

 \bibitem{chap1-key30} \textbf{\textit{Yājñavalkyasmṛti.}} See Pansikar (1926).
