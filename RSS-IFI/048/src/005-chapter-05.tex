...
\begin{myquote}
``The composer's (Thyagaraja) contemporary, Vedanayagam\index{Sastriyar, Vedanayaga@Sastriyar, Vedanayaga} Sastriar, created songs and operas in the Carnatic\index{Karnatic@Karnatic} style. Some of the tunes are very closely modelled on Tyagaraja's\index{Tyāgarāja@Tyagaraja} songs. `Sujana Jivana' (Harikamboji) has a parallel in `Parama Pavana'. At this point in time it is impossible to state who borrowed whose tune and made it his own". 
