...
The \textit{Rāgam tānam pallavi}\index{raga-tana-pallavi@\textit{rāga-tāna-pallavi}}\index{tana@\textit{tāna}}\index{RTP - see raga-tana-pallavi@RTP - see \textit{rāga-tāna-pallavi}|gobble} which was earlier an integral part of all concerts is not so now, due to the duration of the concerts becoming shorter.
...
While in any system of music, be it Karnatic, Hindustani\index{Hindustani@Hindustani} or Western, the composition has a specific role to play as part of the performing genre, it has a very special place in Karnatic music. Prior to \textit{pallavi}-s\index{raga-tana-pallavi@\textit{rāga-tāna-pallavi}}\index{tana@\textit{tāna}}\index{RTP - see raga-tana-pallavi@RTP - see \textit{rāga-tāna-pallavi}|gobble}\break and \textit{kṛti}-s\index{krti@\textit{kṛti}} forming the core of Karnatic concerts, it was the \textit{Praban\break dha}-s which formed a part of the performance genre. Since the \textit{Prabandha}-s\index{prabandha@\textit{prabandha}} were technical and lengthy, they gave way to \textit{kṛti}-s which became the core material of Karnatic \textit{kacheri}-s.\index{kacheri@\textit{kacheri}}
...
\itemsep=0pt
 ...
 \item \textit{Rāgam tānam pallavi}\index{raga-tana-pallavi@\textit{rāga-tāna-pallavi}}\index{tana@\textit{tāna}}\index{RTP - see raga-tana-pallavi@RTP - see \textit{rāga-tāna-pallavi}|gobble} concert
