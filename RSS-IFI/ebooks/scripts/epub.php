...
class epub {
	...
	public function copyFiles($id,$series) {
		system("rm ../unicode-src/" . $id . "/[0-9][0-9][0-9]-[0-9][0-9][0-9]-*");
		system("rm ../unicode-src/" . $id . "/images/[0-9][0-9][0-9]*");
		
		foreach ($series as $key){
			
			system("cp -r ../unicode-src/" . $key . "/[0-9][0-9][0-9]-[0-9][0-9][0-9]-* ../unicode-src/" . $id . "/.");
			system("cp -r ../unicode-src/" . $key . "/images/[0-9][0-9][0-9]* ../unicode-src/" . $id . "/images/.");
		}
	}
