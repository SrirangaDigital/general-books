...
\Authorline{-- Sharda Narayanan$^{\ast}$}\footnotetext{*pp.~\pageref{chapter9}\enginline{--}\pageref{chapter9-end}. In: Kannan, K. S and Meera, H. R. (Ed.s) (2021). \textit{Chronology and Causation: Negating Neo-Orientalism.} Chennai: Infinity Foundation India.}
...
\textit{Rasa} is said to be the cumulative result of \textit{vibhāva}\index{vibhava@\textit{vibhāva}} (stimulus), \textit{anubhāva}\index{anubhava@\textit{anubhāva}} (reaction) and \textit{vyabhicāri-bhāva}\index{vyabhicaribhava@\textit{vyabhicāri-bhāva}} (transitory states), the mood that the performance evokes. The famous \textit{rasa--sūtra} states - “\textit{vibhāva-anubhāva-vyabhicāri-saṁyogāt rasa-niṣpattiḥ}\dev{।}" (Dwivedi 1996: 34).
