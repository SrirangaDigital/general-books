...
\end{flushright}} in order to avoid the extremes of eternalism and annihilationism, and keep strictly to the Middle Way\index{Middle Way, the}\endnote{ “If I, Ananda, when the wandering monk Vachhagotta asked me: ‘Is there the ego?’ had answered: ‘The ego is’ then that, Ananda, would have confirmed the doctrine of the Sramanas\index{Sramanas@Śramaṇas} and Brahmins who believe in permanence (of the ego). If I, Ananda, had answered: ‘The ego is not’, then that, Ananda, would have confirmed the doctrine of the Sramanas and Brahmins, who believe in annihilation (of the ego).”
...
\begin{flushright}
Strong (1902: 112)
\end{flushright}}. There should be a way to overcome the hardships of \textit{saṁsāra}. Logically, it then follows that there must be a Highest Reality. The Buddha called it \textit{nirvāṇa},\index{nirvana@\textit{nirvāṇa}} and this state akin to the Upaniṣadic \textit{Brahman}.
