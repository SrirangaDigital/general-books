...
\chapter{\hspace{7.32cm} \hfill Othering\index{othering}\break and Indian Population Genetics}\label{chapter10}

\Authorline{-- Murali K. Vadivelu}\footnote{pp.~\pageref{chapter10}\enginline{--}\pageref{chapter10-end}. In: Kannan, K. S and Meera, H. R. (Ed.s) (2021). \textit{Chronology and Causation: Negating Neo-Orientalism.} Chennai: Infinity Foundation India.}

\lhead[{\small\thepage}\quad\small Murali K. Vadivelu]{}
...
\item GRAMMAR – Saraswat, Manorama, Chandrika, Bhashya, Laghu Kaumudi, Paniniya\index{Panini@Pāṇini} Vyakaran, Kaumudi, Siddhant Kaumudi, Shekar, Prakrita Prakasa
 ...
 \item LAW – Manu\index{Manu}\index{Manusmrti@Manusmṛti} Smriti, Parasara Smriti, Yagya Valk Gautama,\index{Gautama (sage)} Mitakshara
 ...
 \item RELIGION – Rigveda\index{Rgveda@\textit{Ṛgveda}} Sanhita (rare), Samaveda,\index{Samaveda@\textit{Sāmaveda}} Mantra Bhaga, Yajurveda,\index{Yajurveda@\textit{Yajurveda}} Shukla Yajur Chhandasya Archika (very rare), Vajasneyi Sanhita”
