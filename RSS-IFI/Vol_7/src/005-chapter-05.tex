...
\begin{enumerate}
\itemsep=0pt
\item \textit{purāṇam\index{purana@\textit{purāṇa}} itivṛttam ākhyāyika-udāharaṇaṁ dharmaśāstraṁ cetītihāsaḥ} (\textit{Arthaśāstra}\index{Arthasastra@\textit{Arthaśāstra}} I.5),

 \item 
 \textit{dharmārtha-kāma-mokṣāṇām\index{moksa@\textit{mokṣa}} upadesa-samanvitam}.
