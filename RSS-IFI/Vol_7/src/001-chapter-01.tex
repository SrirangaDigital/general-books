...
\Authorline{Megh Kalyanasundaram$^{\ast}$}\footnotetext{*pp.~\pageref{chapter1}\enginline{--}\pageref{chapter1-end}. In: Kannan, K. S. and Meera, H. R. (Ed.s) (2021). \textit{Chronology and Causation: Negating Neo-Orientalism.} Chennai: Infinity Foundation India.}
...
\begin{longtable}{|c|p{1.9cm}|p{1.9cm}|p{1.5cm}|p{1.1cm}|}
\hline
...
\subsubsection*{3.1.1 Sātavāhana-s}\index{Satavahanas@Sātavāhanas}
...
\begin{longtable}{|p{1.3cm}|p{3.5cm}|p{3.6cm}|}
\hline
...
\hline
\textbf{A}ryan problem & Subscribes to the Aryan-migration-into-Bhārata theory (AMT)\index{Aryan Migration Theory}.\index{AMT - See Aryan Migration Theory|gobble} Attributes Sanskrit, Veda-s to migrators rather than Bhārata’s indigenous conceptions. Dates, or endorses dating of Veda-s on the basis of AMT. & Questions the Aryan-migration-into-Bhārata theory (AMT), the non-attribution of Sanskrit and Veda-s to indigenous conceptions and the dating of Veda-s on the basis of AMT. \\
\hline
...
\begin{longtable}{|l|p{2.5cm}|p{2.5cm}|p{2cm}|}
\hline
...
\begin{longtable}{|l|p{1.1cm}|p{1.97cm}|p{1.98cm}|p{1.97cm}|}
\hline
...
\bibitem{chap1-key01} Bechert, Heinz. (1995). \textit{When Did The Buddha Live? The Controversy on the Dating of the Historical Buddha}. Delhi: Sri Sathguru Publications, Indological and Oriental Publishers, A Division of India Books Center.
 ...
 \bibitem{chap1-key25} —. (2006). \textit{The Language of Gods in the World of Men}. Berkeley : University of California Press.
 ...
 \bibitem{chap1-key27} —. (2010). ``Comparison Without Hegemony". In Joas and Klein (2010). pp. 185-204.
