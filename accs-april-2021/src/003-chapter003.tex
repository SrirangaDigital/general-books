...
\includegraphics[scale=.65]{src/Figures/chap3/table5.jpg}
\end{table}
...
\includegraphics[scale=.65]{src/Figures/chap3/table6.jpg}
\end{table}


\begin{thebibliography}{99}

\bibitem{art3-key01} Aspiring Minds, ``National Employablity Report - Engineers Annual Report 2019", 

\url{https://www.aspiringminds.com/wp-content/uploads/2019/05/NER\_Engineer\_2019-V5}, last accessed March 2021.

\bibitem{art3-key02} Anany Levitin, ``Introduction to the Design and Analysis of Algorithms", 2$^{\rm nd}$ edition, Pearson Education.

\bibitem{art3-key03} Alexander Bogomolny, ``Interactive Mathematics Miscellany and Puzzles", 
