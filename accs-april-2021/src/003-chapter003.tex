...
\noindent\centerimg[width=\paperwidth]{src/Figures/chap3/fig001.jpg}
\end{textblock}
%~ \begin{center}
%~ \textbf{``Work is what we do, not a place we travel to"}\\[-.4cm]
%~ \end{center}
%~ \noindent\makebox[\textwidth]{\includegraphics[width=1.05\paperwidth,height=15.2cm]{src/Figures/chap3/fig001.jpg}}
