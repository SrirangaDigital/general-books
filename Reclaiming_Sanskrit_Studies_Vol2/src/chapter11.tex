...
{\sl Pramāṇa} \index{pramana} -- ``Means to acquire knowledge''
...
The principal means of {\sl pramāṇa},\index{pramana} recognized across most Indian schools of thought are Perception ({\sl Pratyakṣa}),\index{pratyaksa} Inference ({\sl Anumāna}),\index{anumana} Analogy ({\sl Upamāna}),\index{upamana} Postulation ({\sl Arthāpatti}),\index{arthapatti} Cognitive Proof ({\sl Anupalabdhi})\index{anupalabdhi} and Testimony ({\sl Śabda}).\index{sabda} For purposes of the current discussion (evaluating the validity of the claims made by Western Indology), it will suffice to know that most of Western Indology is based on their own internal {\sl Śabda} and Western {\sl siddhānta} and use the (traditional) sources of knowledge in a dissonant manner,  primarily with a non-sacred {\sl saṃ\-skāra}. The {\sl pramāṇa} need to be constrained by the appropriate {\sl saṁskāra}.
\begin{myquote}
...
Bohman\index{Bohman, James} writes:
\begin{myquote}
...
There are many definitions of Marxism,\index{Marxism} so to be fair, let us use the crowd-edited version from the Wikipedia, 
\begin{myquote}
...
The first formal definition of {\sl śāstra} as theory is supposedly by the Mīmāṁsaka viz. Kumārila-bhaṭṭa\index{Kumarila Bhatta}
\begin{myquote}
...
We need to internalise what Aurobindo\index{Aurobindo, Sri} has to say about this :
\begin{myquote}
