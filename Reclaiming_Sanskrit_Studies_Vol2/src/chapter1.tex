...
{\sl Kātantra}\index{Katantra}  is of course a grammatical work. 
...
The legend in question states that on completing his grammar, Pāṇini\index{Panini} offered it to his king, who regarded it highly, and ordered that all people in the country should learn the book, and offered a reward of one thousand gold coins for anybody who could recite it by heart. 
...
Pollock again admits that the evidences offered by him are still ``slender but suggestive'' (Pollock 2006:168). He builds his case on two quotations from the {\sl Mahābhāṣya}\index{Mahabhasya} which have been widely discussed by scholars since a long time. These are the expressions 
\begin{myquote}
...
\end{myquote}
which are offered by Patañjali\index{Patanjali} as illustrations for certain rules. Pollock particularly relies on the second statement and extrapolates from later practices to assert that through this, Patañjali is trying to identify himself.
