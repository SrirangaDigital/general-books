\chapter{On Grammar and Royal Power}\label{chapter\thechapter:begin}

\Authorline{Sowmya Krishnapur\footnote{Sowmya Krishnapur: <email>\\  <pp.\pageref{chapter\thechapter:begin}--\pageref{chapter\thechapter:end}> In Kannan Dr K S, 2018 <book title>}}
...
All this means that, in one paragraph, Pollock forcibly associates\index{Pollock!forcibly associates} Kumāralāta with the Kuāṇa emperor Kāniṣka of the second century CE. And in the very next paragraph, he pushes him to later than fifth century CE. 
