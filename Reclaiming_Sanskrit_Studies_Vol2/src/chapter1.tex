...
\begin{myquote}
{\sl ``yasya prajñā-niṣaṅgocita-sukha-manasaḥ śāstra-tattvārtha-bhartuḥ...'', ``vai\-duṣyaṁ tattva-bhedi...'', ``ādhyeyaḥ sūkta-mārgaḥ kavi-mati-vibhavotsāraṇaṁ cāpi kāvyam''} (Fleet 1960:6). 
\end{myquote}
...
\section{Halāyudha, the author of {\sl\bfseries Kavirahasya}}\label{chap3-sec14}
...
Shastri, Nandkishore (Ed.) (1936) {\sl Laghu Śhabdendu Śhēkhara of M.M.Nagesh Bhatt}. Benares: Bhargava Pustakalaya. 

\bibitem[]{chap3_item22}
Shastri, Pandeya Ramtej (Ed.) (1960) {\sl Kalhana’s Rājatarañgiṇi}. Kashi: Pandit Pustakalaya. 
