...
For example, Abhayanandin's\index{Abhayanandin} {\sl Jainendra-Vyākaraṇa}\index{Jainendravyakarana@\textsl{Jainendra-Vyākaraṇa}} has {\sl `aruṇan mahendro mathurām'} (``Mahendra attacked Mathurā''); {\sl Hemacandra-Vyākaraṇa} has {\sl `aruṇat siddharājo’vantīn'} (``Siddharāja attacked Avanti'') and {\sl `ajayat siddhaḥ saurāṣṭrān'} (``Siddha conquered Saurāṣṭra''). The {\sl Śākaṭāyana-śabdānuśāsana},\index{Sakatayanasabdanusasana@\textsl{Śākaṭāyana-śabdānuśāsana}} mentioned by Pollock later, has {\sl `adahad amoghavarṣo'\-rātīn'} (``Amoghavarṣa burnt the enemies''). In these examples, Siddharāja quoted by Hemacandra was none other than his own patron, viz. the Cālukya monarch, Jayasiṁhasiddharāja\index{Kings!Jayasimhasiddharaja@Jayasiṁhasiddharāja} the second. Śākaṭā\-yana mentions his own patron, the Rāṣṭrakūṭa king Amoghavarṣa.\index{Kings!Amoghavarsa@Amoghavarṣa}\break Based on this, Pollock draws the conclusion that 
\begin{myquote}
