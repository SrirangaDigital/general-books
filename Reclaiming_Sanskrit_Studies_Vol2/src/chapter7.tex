...
Sheldon Pollock’s\index{Sheldon Pollock’s} international collaborative project viz. {\sl Sanskrit Knowledge Systems on the Eve of Colonialism}\index{colonialism} (SKSEC)\index{SKSEC Project} aspires to trace the intellectual history\index{intellectual history} of pre-modern India\index{pre-modern India} in order to gather a “clearer picture” of the professed death of Sanskrit\index{death of Sanskrit} “in the face of European modernity”.\index{European modernity} Superficially, SKSEC demonstrates a spirit of openness towards the multiplicity of possible answers to the complex questions it raises. Yet, a closer reading shows that SKSEC works within a fixed framework of predetermined conjectures \& conclusions, and to these, I wish to draw the readers’ attention. 
...
Sheldon Pollock’s international collaborative project, {\sl Sanskrit Knowledge Systems on the Eve of Colonialism} (SKSEC),\index{SKSEC Project!aims of} is a rather ambitious undertaking. It aspires to trace the intellectual history of pre-modern India in order to gather a “clearer picture” of the professed death of Sanskrit “in the face of European modernity”. 

Intellectual history\index{intellectual history} is an uncharted territory in Indology\index{Indology} — to be sure, it is relatively new to European studies\index{European studies} itself. In general, intellectual history is defined as the study of ideas and intellectual patterns over time, not to be confused with ‘history of ideas’.\index{history of ideas} Peter Gordon,\index{Gordon, Peter} an intellectual historian, writes, 
\begin{myquote}
...
If the Renaissance did not occur even in Europe in the way it is imagined, and showcased to be, it seems rather pointless to demonstrate an “Indian Renaissance”,\index{Indian Renaissance} and draw parallels between the two “movements”. Yet, that is precisely what Sheldon Pollock sets out to do. 
...
To illustrate: (2$^{\rm nd}$ – 1$^{\rm st}$ century BCE) Patañjali  — credited with works on grammar, medicine, and yoga\endnote{The tradition that the same Patañjali\index{Patanjali@Patañjali} wrote treatises on grammar, medicine and yoga is memorialized in a verse by Bhoja in his commentary on the {\sl Yoga-sūtra}-s. Bhoja was perhaps influenced by a verse by Bhartṛhari that speaks of the genesis of the three {\sl śāstra}-s in order to rid one of impurities at the levels of the body, the speech, and the mind viz. {\sl cikitsā} (medicine), {\sl lakṣaṇa} (grammar), and {\sl adhyātma} (spirituality). ({\sl Vākyapadīya}\index{Vakyapadiya@\textsl{Vākyapadīya}} 1.146). Bhoja's verse reads thus: {\sl yogena cittasya padena vācāṁ malaṁ śarīrasya ca vaidyakena} | {\sl yo’pākarot taṁ pravaraṁ munīnāṁ patañjaliṁ prāñjalir ānato’smi} ||;}
...
Daṇḍin’s\index{Dandin@Daṇḍin} {\sl Avantisundarīkathāsāra},\index{Avantisundarikathasara@\textsl{Avantisundarīkathāsāra}} 

Bāṇabhaṭṭa’s\index{Banabhatta@Bāṇabhaṭṭa} {\sl Harṣacarita},\index{Harsacarita@\textsl{Harṣacarita}}

works of Bhavabhūti,\index{Bhavabhuti@Bhavabhūti}

Kalhaṇa’s\index{Kalhana@Kalhaṇa} {\sl Rājataraṅginī},\index{Rajatarangini@\textsl{Rājataraṅginī}} 

Vākpati’s\index{Vakpati@Vākpati} {\sl Gauḍavāho},\index{Gaudavaho@\textsl{Gauḍavāho}} 
...
Jayānaka’s\index{Jayanaka@Jayānaka} {\sl Prithivirājavijaya},\index{Prithivirajavijaya@\textsl{Prithivirājavijaya}} 

Vidyācakravartin’s\index{Vidyacakravartin@Vidyācakravartin} {\sl Gadyakarṇāmṛta},\index{Gadyakarnamrta@\textsl{Gadyakarṇāmṛta}} 

Gaṅgā\-devī’s\index{Gangadevi@Gaṅgādevī} {\sl Madhurāvijaya},\index{Madhuravijaya@\textsl{Madhurāvijaya}} 

Jayasiṁha’s\index{Jayasimha@Jayasiṁha} {\sl Kumārapālacarita},\index{Kumarapalacarita@\textsl{Kumārapālacarita}} 
...
\item[6.] Conclusions without evidence\endnote{Nowhere, for example, is a shred of proof given to substantiate the relation between Muslim rule\index{Muslim rule} and Sanskrit “rejuvenation”}.\index{misinterpretation!techniques of!conclusions sans evidence}
\end{itemize}
