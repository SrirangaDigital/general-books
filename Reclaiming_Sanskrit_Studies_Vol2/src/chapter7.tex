\chapter{{{\sl\bfseries Śāstra}\relax} -- an impediment to progress?}\label{chapter7}
\vskip -10pt
...
The contrarian view is\index{Vedanga} that the Vedāṅga-s especially, Vyākaraṇa and Chandas which are meant to describe the grammar\index{grammar} and prosody used in the Veda; somehow, over time became prescriptive\index{prosody} to the extent that future users of the language were forced to adhere to them more strictly than done in the Veda itself. Such impositions can be found in the context of Dharmaśāstra-s, Āyurveda etc. In this way, it is claimed that the discourse on the\index{sastra (śāstra)! prescriptive} application of {\sl śāstra}-s which was descriptive and\index{sastra (śāstra)! descriptive} ﬂexible in spirit and to begin with, over time has become prescriptive and rigid, thereby stiﬂing the contributions from the creative intelligence of all sections of society.
...
That by which the existence of a thing is proved is called a {\sl pramāṇa}.\index{sastra (śāstra)! pramana} In other words, any knowledge is valid only if it is born out of a {\sl pramāṇa}. The deﬁnition of a {\sl pramāṇa}\index{pramana}  is {\sl anadhigata, abādhita, arthavat bodhaka. Bodhaka} indicates the revealing nature of a {\sl pramāṇa}, with the other three words explained thus:
...
\index{sastra (śāstra)! definition and scope}
