\chapter[Practice {\sl  v/s} Theory: Gaṇita and...]{Practice {\sl\bfseries v/s} Theory: Gaṇita and Mathematics}\label{chapter\thechapter:begin}

\Authorline{Subhodeep Mukhopadhyay\footnote{Subhodeep Mukhopadhyay: <email>\\  <pp.\pageref{chapter\thechapter:begin}--\pageref{chapter\thechapter:end}> In Kannan Dr K S, 2018 <book title>}}
