...
But Pollock does not stop there.  He says that, in accordance with {\sl Satkāryavāda},\index{Satkāryavāda@\textit{Satkāryavāda}} Indian intellectuals believed - that all knowledge, including that of practice not only pre-exists, but that pre-exists in something; specifically in textual materials.
