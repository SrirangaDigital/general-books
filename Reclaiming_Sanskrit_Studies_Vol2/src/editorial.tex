...
Western Indology has not remained as bad as it used to be; it has steadily worsened and is getting the more and the more debased - being answerable first of all to the exigencies and executions of the military-political-industrial complex of their bosses. When have academia in the West not been a tool of their funding agencies? At the other end, again, modern science\index{science!modern} is not without its own biases; social sciences are more often than not biases sophisticated; and the “humanities are their own god”.
