\chapter[Indian Renaissance — a Birth \& a Death]{Indian Renaissance —\break \centerline{a Birth \& a Death}}\label{chapter2}
...
If the Renaissance didnot occur even in Europe in the way it is imagined, and showcased be, it seems rather pointless to demonstrate an “Indian Renaissance”, and draw parallels between the two “movements”. Yet, that is precisely what Sheldon Pollock sets out to do. 
...
Neither the Figure nor the Table, supports as can see, Pollock’s flavor of argument in respect of either peaks or troughs.
