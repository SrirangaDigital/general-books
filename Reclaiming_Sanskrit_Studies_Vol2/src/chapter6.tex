...
Pollock derives the ``power'' of his philology from the Post-modern views of language. The `power discourse'\index{power discourse} that he attempts to `see' in historical text, is also influenced by these Post-modern perspectives.\\[-20pt]
...
On textual meaning,\index{Pollock!textual meaning}\index{philology!textual meaning (level 1)} he says
\begin{myquote}
...
On contextual meaning,\index{Pollock!contextual meaning}\index{philology!contextual meaning (level 2)} he says,
\begin{myquote}
...
On the third and final meaning,\index{philology!philologist's meaning (level 3)} viz the Philologist's meaning,\index{Pollock!philologist’s meaning} Pollock says
\begin{myquote}
...
This has been something Western intellectualism finds difficult to internalise. Pursuit of lifestyles that conform to a Vedic cosmology\index{cosmology} (=beliefs in {\sl karman, dharma, punar-janman} (rebirth) etc.) require stable societies: stability in time, place for humans to evolve spiritually, become aware of higher planes of consciousness, and practice life (as per {\sl śāstraic} guidelines) so that the traversal across the \hbox{{\sl puruṣārtha}-s}\index{purusarthas@\textsl{puruṣārthas}} (goals and aims of life) is as it ought to be, leading to  possible transcendence\index{transcendence} in the current life and possibly lead to a final {\sl mokṣa}  (liberation / escape from the cycles of rebirth and the attainment of a higher consciousness).
