...
\Authorline{Sudarshan Therani Nadathur\footnote{Sudarshan Therani Nadathur: tnsudarshan@gmail.com\\  <pp.\pageref{chapter6\thechapter:begin}--\pageref{chapter6\thechapter:end}> In Kannan Dr K S, 2018 <book title>}}
...
\hfill \hbox{(Phillips 2015) (italics ours)}\index{Phillips, Stephen}
\end{myquote}
