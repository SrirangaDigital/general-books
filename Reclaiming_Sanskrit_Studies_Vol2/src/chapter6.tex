\chapter{The Science and Nescience of Śāstra}\label{chapter6}
\vskip -10pt
...
The well-known {\sl Nāsadīya Sūkta}\index{Nasadiyasukta@Nāsadīya Sūkta} ({\sl Ṛg Veda} 10.129) is considered as the origin for the later development of the Sāṅkhya as a distinct {\sl darśana}. The oft-quoted verse from the Śānti Parvan of the {\sl Mahābhārata}\index{Mahabharata@Mahābhārata} on the Sāṅkhya
\begin{myquote}
...
\begin{myquote}
The Supreme Good is {{\sl\bfseries mokṣa}\relax}\index{moksa@mokṣa} which consists in the permanent impossibility of the incidence of pain... in the realisation of the Self as Self pure and simple.
...
The first formal definition of {\sl śāstra} as theory is supposedly by the Mīmāmsāka viz. Kumārila-bhāṭṭa\index{Kumarila Bhatta@Kumārila Bhaṭṭa}
\begin{myquote}
...
Using  selective quoting,\index{Pollock!selective quoting} the {\sl Mahābhārata}, {\sl Nāradasmṛti},  the {\sl dharma\-śāstra} texts,  {\sl Kāvyamīmāṁsā} (poetics), {\sl Kāmasūtra},  {\sl Matsyapurāṇa},  {\sl Caraka\-saṁhitā} (Āyurveda/medicine),  {\sl Suśrutasaṁhitā} (surgery/\-medicine),  {\sl Agnipurāṇa}, {\sl Bharata-Nāṭyaśāstra} (dance, performing art), the {\sl Dhanurveda} texts (archery), {\sl Pākadarpaṇa} (cooking) -- have all been labelled as myth.
\begin{myquote}
