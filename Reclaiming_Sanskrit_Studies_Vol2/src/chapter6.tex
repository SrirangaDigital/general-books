...
In the final section of his paper, Pollock makes serious charges against the very nature of the Veda, its primacy and its primordial origins and thereby of all {\sl śāstra}-s. He quotes {\sl Caraka-saṁhitā}\index{Caraka-Samhita@\textsl{Caraka-saṁhitā}} - 
\begin{myquote}
...
To make the claim that even in this presupposition, theory precedes practice, Śaṅkara's {\sl Bhāṣya} on the {\sl Brahma Sūtra}-s\index{Brahmasutra@\textsl{Brahma-sūtra}-s} is quoted selectively and out of context.\index{misinterpretation!techniques of!error/out-of-context quotation} Pollock now claims 
\begin{myquote}
