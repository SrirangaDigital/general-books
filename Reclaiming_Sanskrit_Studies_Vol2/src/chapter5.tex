\chapter{Did Indian Intellectual tradition hold that all knowledge of practice is contained in {{\sl\bfseries śāstra}\relax}-s?}\label{chapter5}
\vskip -10pt
...
Indian intellectual believed that {{\sl śāstra}\relax}-s\index{sastra} of practice are divine in origin; therefore they are perfect. Since {{\sl śāstra}\relax}-s are perfect, there is no scope for improving them. Therefore, there is no scope for original research
...
Assent-worthiness\index{sastra!assent-worthiness} of {\sl śāstra}-s of practice can be questioned even if the {\sl śāstra} claims divine origin.
