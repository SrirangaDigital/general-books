...
As the dictum of the Sāṅkhya-s\index{Sankhya} viz. ``{\sl bhogāpavargārtham sṛṣṭiḥ}''\endnote{``{\sl pradhānaṁ hi puruṣasyātmano bhogāpavargau kurvad upakaroti}'' ({\sl Śaṅkara Bhāṣya} on {\sl Brahma Sūtra}\index{Brahmasutras@\textsl{Brahma-sūtra}-s} 1.1.6)} expounds, ``creation'' is for the sake of the {\sl jīva} for the two-fold purpose of 
\begin{itemize}
\itemsep=0pt
...
\hfill({\sl Bṛhad-āraṇyaka Upaniṣad}\index{Upanisad@Upaniṣad!Brihadaranyaka@\textsl{Bṛhadāraṇyaka}} 1.5.16)
\end{quote}
