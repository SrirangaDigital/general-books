...
\hfill 	(Horsten\index{Horsten} 2016)
\end{myquote}
...
\hfill	(Bag\index{Bag, A.K.} 1990:4)
\end{myquote}
...
\hfill (Krantz \index{Krantz, S.G.} 2007:7-8)
\end{myquote}
...
\hfill \hbox{(Cole\index{Cole, Julian C.} 2016)}
\end{myquote}
...
\hfill 	(Raju\index{Raju, C.K.} 2011b:276)
\end{myquote}
