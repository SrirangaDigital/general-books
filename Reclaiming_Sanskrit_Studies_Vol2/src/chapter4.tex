...
\item The eternality of the Veda-s,\index{Veda-s} the {\it śāstra} par excellence, is one presupposition or justification for this assessment of {\it Śāstra}.
...
Pollock condemns the {\sl śāstric} codification\index{sastra@\textsl{śāstra}!codification} and its normative character, and says that it was this attitude that prompted him to further study in the area of {\sl śāstric} regulation, conceived accordingly as an analysis of the components of cultural hegemony\index{cultural!hegemony} or at least authoritarianism.\index{authoritarian} He asserts that the question of domination remains important for several areas of pre-modern India, and everywhere civilisation as a whole has been constrained by rules of varying strictness. (Pollock 1985:499)
...
My assessment of Pollock writing on this subject is that he is ceaselessly wandering and searching for in the Indian system to prove his point. No doubt he seeks to substantiate his thesis by drawing together evidence from a wide variety of sources. But, as Hanneder\index{Hannedar, Jurgen} says, Pollock's argumentation is ``often arbitrary'';\index{misinterpretation!techniques of!flawed arguments} in his review of Pollock's paper on ``The Death of Sanskrit'', Hanneder says ``...it is my impression that Pollock has over-interpreted the evidence to support his theory...'' (Hanneder\index{Hannedar, Jurgen} 2002:294). Even here, in most cases, where he is unable to convince the reader, he tries to confuse! First of all, the very basic idea of {\it śāstra} that he uses to start his argument is not well-defined. He quotes from a wide range of texts and tries to arrive at a single definition of {\it śāstra}, which he can then conveniently use to drive his point. 
...
He also mentions \textsl{Chāndogya Upaniṣad's}\index{Upanisad@Upaniṣad!Chandogya@\textsl{Chāndogya}} and Yaśodhara's\index{Yashodhara@Yaśodhara} view - that {\it śāstra} makes practice `stronger', reliable, and consistent, unlike uninformed practice, whose effectivity is altogether fortuitous. (Pollock 1985:507)
