\chapter{On the role of {\sl\bfseries Śāstra} : an Examination}\label{chapter4\thechapter:begin}\label{chapter4}
\vskip -10pt

\Authorline{K. Vrinda Acharya\footnote{K. Vrinda Acharya: vrindacharya@gmail.com\\  <pp.\pageref{chapter4\thechapter:begin}--\pageref{chapter4\thechapter:end}> In Kannan Dr K S, 2018 <book title>}}
