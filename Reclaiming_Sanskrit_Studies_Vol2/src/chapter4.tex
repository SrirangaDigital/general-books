...
\item All knowledge is pre-existent, and progress can only be achieved by a regressive re-appropriation\index{re-appropriation} of the past.
...
Pollock condemns the {\sl śāstric} codification\index{sastra@\textsl{śāstra}!codification} and its normative character, and says that it was this attitude that prompted him to further study in the area of {\sl śāstric} regulation, conceived accordingly as an analysis of the components of cultural hegemony\index{cultural!hegemony} or at least authoritarianism. He asserts that the question of domination remains important for several areas of pre-modern India, and everywhere civilisation as a whole has been constrained by rules of varying strictness. (Pollock 1985:499)
...
My assessment of Pollock writing on this subject is that he is ceaselessly wandering and searching for in the Indian system to prove his point. No doubt he seeks to substantiate his thesis by drawing together evidence from a wide variety of sources. But, as Hanneder\index{Hanneder, Jurgen} says, Pollock's argumentation is ``often arbitrary'';\index{misinterpretation!techniques of!flawed arguments} in his review of Pollock's paper on ``The Death of Sanskrit'', Hanneder says ``...it is my impression that Pollock has over-interpreted the evidence to support his theory...'' (Hanneder\index{Hannedar, Jurgen} 2002:294). Even here, in most cases, where he is unable to convince the reader, he tries to confuse! First of all, the very basic idea of {\it śāstra} that he uses to start his argument is not well-defined. He quotes from a wide range of texts and tries to arrive at a single definition of {\it śāstra}, which he can then conveniently use to drive his point. 
...
\begin{quote}
{{\sl ``atra sarveṣāṁ śāstrāṇāṁ bhagavaty eva tātparyaṁ sākṣāt-\break paramparayā veti samāsena teṣāṁ prasthāna-bhedo 'troddiśyate''}}\hfill  \hbox{{\sl Prasthāna-bheda} (p.1)} 
\end{quote}
\noindent
...
For instance, he quotes a passage from the {\it Manu-smṛti}\index{Manusmrti@\textsl{Manu-smṛti}} which talks about a certain code of conduct with respect to greeting another person. He then exclaims that students in the West ``are amazed to find even so apparently simple an act as meeting another person encumbered with a whole battery of rules'', and thus find Indian culture very alien. He then goes on to quote a section from a book called \textsl{Amy Vanderbilt’s Everyday Etiquette},\index{Vanderbilt, Amy}\index{Everyday Etiquette@\textsl{Everyday Etiquette}} which prescribes rules for shaking hands, smiling, removing hats, etc., while meeting somebody. 
...
Further, he quotes from the book `\textsl{The Concept of Mind}'\index{Concept of Mind, The@\textsl{Concept of Mind, The}} by Gilbert Ryle,\index{Ryle, Gilbert} the well known British philosopher, thus: 
\begin{myquote}
...
This doesn't make much sense to me. First of all in India, cultural values are more assimilated than formally learnt from texts. Those who have studied the {\it śāstra}-s are only a few, but cultural codes\index{cultural!codes} and practices are an inseparable aspect of almost every Indian/Hindu which he/she learns by living the culture.  Secondly, if Western codes are `tacit' as he calls them, where was the need for a book like \textsl{Amy Vanderbilt's Everyday Etiquette}\index{Vanderbilt, Amy}\index{Everyday Etiquette@\textsl{Everyday Etiquette}} which dictates cultural grammars\index{grammar!cultural@- cultural} in great detail?
...
\begin{enumerate}
\item He first says that although the word {\it śāstra} is attested from the time of the earliest literary monuments, no comprehensive definition is offered until the medieval period (Pollock 1985:501). But later on, while talking of Madhva's\index{Madhvacarya@Madhvācārya} definition of {\it śāstra}, he himself says it is that which is found in the {\it Skāndapurāṇa}\index{Skanda Purana@\textsl{Skānda Purāṇa}}\index{Purana@\textsl{Purāṇa}!Skanda@\textsl{Skānda}} (Pollock 1985:503), which definitely belongs to a period much earlier than the so-called medieval period. He also quotes definitions of {\it śāstra} from Pūrva Mīmāṁsā and Patañjali.\index{Patanjali@Patañjali} 
...
Also, in the development of Sanskrit grammatical tradition, the  {\it Vārttika}-s of Vararuci\index{Vararuci} enunciate as much as 5000 exceptions to rules made by Pāṇini,\index{Panini@Pāṇini} out of which {\it Mahābhāṣya}\index{Mahabhasya@\textsl{Mahābhāṣya}}\index{Vyakarana@\textsl{Vyākaraṇa}!texts!Mahabhasya@\textsl{Mahābhāṣya}} of Patañjali\index{Patanjali@Patañjali} negates 3000, and accepts the other 2000. Down the line, there were several other illustrious grammarians like Jayāditya,\index{Jayaditya@Jayāditya} Nāgeśabhaṭṭa,\index{Nagesabhatta@Nāgeśabhaṭṭa} Kaiyaṭa\index{Kaiyata@Kaiyaṭa}  and so on, who made significant contributions to Sanskrit grammar. This proves the fact that Sanskrit grammar\index{Sanskrit!grammar}  was never fixed or frozen.
...
Firstly, {\it chandas}\index{chandas@\textsl{chandas}} or metrics did not stop with Piṅgala.\index{Pingala@Piṅgala} Kedārabhaṭṭa's\index{Kedarabhatta@Kedārabhaṭṭa} \textsl{Vṛtta-ratnākara}\index{Vrttaratnakara@\textsl{Vṛtta-ratnākara}} and many other texts on metrics can be identified with the middle ages of Sanskrit prosody. 
...
He also mentions \textsl{Chāndogya Upaniṣad's}\index{Upanisad@\textsl{Upaniṣad}!Chandogya@\textsl{Chāndogya}} and Yaśodhara's\index{Yashodhara@Yaśodhara} view - that {\it śāstra} makes practice `stronger', reliable, and consistent, unlike uninformed practice, whose effectivity is altogether fortuitous. (Pollock 1985:507)
...
\item He cites from \textsl{Caraka-saṁhitā}\index{Carakasamhita@\textsl{Caraka-saṁhitā}} thus ``Of all types of evidence, the most dependable is that directly observed.'' (Pollock 1985:510)
\end{enumerate}
...
The question that is persistently bothering me is -- has there been no {\it pūrva-pakṣa}\index{purvapaksa@\textsl{pūrva-pakṣa}} done by our traditional scholars for so many years for an article written as early as 1985? If yes, has it been effective? If not, it is highly unfortunate! The Swadeshi Indology\index{Indology} Conference is a great step towards filling this lacuna and building a home team of scholars who can give appropriate rebuttals to the likes of Pollock.
...
\bibitem[]{chap9_item4}
{\sl\bfseries Kāvyamīmāṁsā} of Rājaśekhara. See Dalal and Sastry (1934). 


\bibitem[]{chap1_item5}
{\sl\bfseries Mahābhārata} (1958). (No editor). Gorakhpur: Gita Press.

\bibitem[]{chap1_item6}
{\sl\bfseries Mālavikāgnimitra}. See Parab (1924). 

\bibitem[]{chap9_item7}
Malhotra, Rajiv (2016). \textsl{The Battle for Sanskrit}. Noida: HarperCollins Publishes India.

\bibitem[]{chap9_item8}
---\kern3pt(2013). \textsl{Being Different}. Paperback edition. Noida: HarperCollins Publishes India.

\bibitem[]{chap9_item9}
{\sl\bfseries Muṇḍaka Upaniṣad}. See Singh (1987). 
...
{\sl\bfseries Śrīmad Bhagavad-gītā}. See Vireswarananda (1989). 

\bibitem[]{chap9_item17}
Vireswarananda, Swami (Trans.) (1989). \textsl{Srimad Bhagavad-gītā}. Madras: Sri Ramakrishna Math.

\bibitem[]{chap9_item18}
{\sl\bfseries Viṣṇutattva-vinirṇaya}. See Prahladacharya and Bhat (2008).
\end{thebibliography}
