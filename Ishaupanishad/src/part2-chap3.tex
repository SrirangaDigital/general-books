...
\emph{codanālakṣaṇo 'rtho dharmaḥ ।}
...
\item
  The table has been reproduced from an article by Hariprasad Nellitheertha titled `\emph{Ṣoḍaśa} \emph{saṁskāra-s} -- The Sixteen Rites To Mark The Passage Of Life', Indic Today {[}http://www.indictoday.com/perspective/sixteen-samskaras/{]}
\item
  Sri Chandrasekharendra Saraswathi, `Names of \emph{saṁskāra-s}', in `Hindu \emph{Dharma}', Bharatiya Vidya Bhavan {[}http://www.\emph{kāma}koti.org/hindudharma/part16/chap8.htm{]}
\end{enumerate}
...
\toprule
~ & \textbf{Fire} & \textbf{Fuel} & \textbf{Smoke} & \textbf{Flame} & \textbf{Cinder} & \textbf{Spark} & \textbf{Oblation} & \textbf{Fruit of the Sacrifice}\tabularnewline
\midrule
\endhead
\textbf{1} & \emph{Svarloka}/ Heaven & \emph{Āditya} / Sun & Light-rays & Day & Four-Quarters & Intermediate Quarters & \emph{Śraddhā} / Faith & Soma\tabularnewline
\textbf{2} & \emph{Parjanya}/ the Deity of Rain & Year & Clouds & Lightning & Thunder & Rumblings & \emph{Soma} & Rain\tabularnewline
\textbf{3} & \emph{Bhūloka} & Earth & Fire & Night & Moon & Stars & Rain & Food\tabularnewline
\textbf{4} & Man & Open Mouth & \emph{Prāṇa} & Speech & Eyes & Ear & Food & Semen\tabularnewline
\textbf{5} & Woman & ~Phallus & Pubic Hair & ~\emph{Yoni}/ Vulva & Sexual Intercourse & Sexual delight (orgasm)~ & Semen & Offspring\tabularnewline
\bottomrule
\end{longtable}
...
\item
Swami Sivananda, `Vidyas from the \emph{Upaniṣad}s', The Divine Life Society. {[}\href{http://sivanandaonline.org/public_html/?cmd=displaysection \&section_id=759}{http://sivanandaonline.org/public\_html/?cmd=displaysectionandsection\_id=759}{]}
\item
