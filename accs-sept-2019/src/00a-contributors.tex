...
\includegraphics[scale=3.6]{src/Figures/authors/Rajavelsamy.png}
...
\includegraphics[scale=.26]{src/Figures/authors/D-Das.png}
...
\includegraphics[scale=.045]{src/Figures/authors/NBhat.png}
...
\includegraphics[scale=.92]{src/Figures/authors/SanjeevG.png}
...
\includegraphics[scale=.77]{src/Figures/authors/Aparna-Gooru-Lab.png}
...
\includegraphics[scale=.72]{src/Figures/authors/srinath_srinivasa.png}
...
\begin{wrapfigure}{l}{2.65cm}
\vspace{-12pt}

\includegraphics[scale=.75]{src/Figures/authors/Prasad_Ram,_June_2019.png}
...
\includegraphics[scale=.83]{src/Figures/authors/Rustagi_RPR-PP-Photo.png}
...
\includegraphics[scale=.9]{src/Figures/authors/Viraj_Kumar.png}
