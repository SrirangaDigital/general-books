...
\section*{Exercise \thnum{1}\label{chap2-exe01}}
...
\section*{Exercise \thnum{2}\label{chap2-exe02}}
...
\section*{Exercise \thnum{3}\label{chap2-exe03}}
...
\section*{Exercise \thnum{4}\label{chap2-exe04}}
...
\begin{itemize}
   ...
   \texttt{sudo apt install xgraph}  \raisebox{-.1cm}{\includegraphics[scale=.9]{src/Figures/circledC.eps}}
