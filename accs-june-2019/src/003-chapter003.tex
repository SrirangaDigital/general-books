...
\begin{figure}[H]
\centering
\includegraphics[scale=1.05]{src/Figures/chap3/chap3-fig01.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.10]{src/Figures/chap3/chap3-fig02.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.05]{src/Figures/chap3/chap3-fig03.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.05]{src/Figures/chap3/chap3-fig04.jpg}
\caption{ Basic setup for experiential learning}\label{chap3-fig04}
\end{figure}

\noindent
\section{Exercise 1}\label{chap3-Exe1}
...
\url{python3  accs_server.py -b 200 -d 1 -p 9999} 
...
\url{python3 accs_client.py -s 10.211.55.2 -p 9999 -b 100 -d 2 -c 1000}
...
20:09:21.091424 IP 10.211.55.10.60892 $>$ 10.211.55.2.9999: Flags [.], ack 201, win 237, options [nop,nop,TS val 1385669 ecr 780230225], length 0
...
\noindent
\section{Exercise 2}\label{chap3-Exe2}
...
\noindent
\section{Exercise 3}\label{chap3-Exe3}
