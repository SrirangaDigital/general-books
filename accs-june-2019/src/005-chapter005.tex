\chapter{Experiential Learning\\ of Networking Technologies\\ {\LARGE\sl Understanding TCP Flow Control}}
...
\noindent\makebox[\textwidth]{\includegraphics[width=1.05\paperwidth,height=13cm]{src/Figures/EL.jpg}}
\newpage
