...
We have so far focussed on the computation and storage applications, which employ traditional dimensional/feature scaling (\ref{chap1-fig7}). In the last couple of decades, a new wave of functional scaling has emerged to realize hybrid systems on chips (hybrid SoCs), consisting of sensors and actuators along with the computation and storage elements. It is important to recognize that the miniaturization of electronic chips has been driven by the emergence of new system driver, alomost every decade as shown in \ref{chap1-fig7}.
...
\begin{figure}[H]
\centering
\includegraphics[scale=1.4]{src/Figures/chap1/chap1-fig06.jpg}
