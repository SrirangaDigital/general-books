...
Some of the technological drivers for 5G include developments in massive MIMO, cognitive radios, millimeter wave communications, network virtualization, software defined networking, etc. An underlying technology that has enabled most of these developments possible is the continued miniaturization of devices in the nano scale regime and the capability to manipulate the matter at these dimensions. This is expected to revolutionize the future systems for computation, storage and perception in the next few decades. In their article titled ‘Nanotechnology and the Future of Computation, Storage and Perception’ the authors foresee availability of very powerful artificial intelligence (AI) and machine learning (ML) hardware chips, enabled by the integration of new compute and storage technologies co-existing with a variety of sensors. 
