...
\begin{tabular}{p{.2\paperwidth}@{}!{\color{goldan-yellow}\vline width .9pt}p{.64\paperwidth}}
...
Security continues to be a major issue in 5G systems as well. The 3rd Generation Partnership Project (3GPP) defined 5G system envisages fundamental changes on top of its former cellular systems in several design areas including security. In their paper titled ‘A Review on 3GPP 5G Security Aspects’ the authors discuss the key enhancements specified by the 3GPP for the 5G system, particularly those that differ from the previous 4G system and the rationale for the same.
